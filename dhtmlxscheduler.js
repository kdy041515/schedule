...
<a class="dhx_cal_ltitle_close_btn scheduler_icon close"></a>
  ...
  const ar = { date: { month_full: ["ÙƒØ§Ù†ÙˆÙ† Ø§Ù„Ø«Ø§Ù†ÙŠ", "Ø´Ø¨Ø§Ø·", "Ø¢Ø°Ø§Ø±", "Ù†ÙŠØ³Ø§Ù†", "Ø£ÙŠØ§Ø±", "Ø­Ø²ÙŠØ±Ø§Ù†", "ØªÙ…ÙˆØ²", "Ø¢Ø¨", "Ø£ÙŠÙ„ÙˆÙ„", "ØªØ´Ø±ÙŠÙ† Ø§Ù„Ø£ÙˆÙ„", "ØªØ´Ø±ÙŠÙ† Ø§Ù„Ø«Ø§Ù†ÙŠ", "ÙƒØ§Ù†ÙˆÙ† Ø§Ù„Ø£ÙˆÙ„"], month_short: ["ÙŠÙ†Ø§ÙŠØ±", "ÙØ¨Ø±Ø§ÙŠØ±", "Ù…Ø§Ø±Ø³", "Ø£Ø¨Ø±ÙŠÙ„", "Ù…Ø§ÙŠÙˆ", "ÙŠÙˆÙ†ÙŠÙˆ", "ÙŠÙˆÙ„ÙŠÙˆ", "Ø£ØºØ³Ø·Ø³", "Ø³Ø¨ØªÙ…Ø¨Ø±", "Ø£ÙƒØªÙˆØ¨Ø±", "Ù†ÙˆÙÙ…Ø¨Ø±", "Ø¯ÙŠØ³Ù…Ø¨Ø±"], day_full: ["Ø§Ù„Ø£Ø­Ø¯", "Ø§Ù„Ø£Ø«Ù†ÙŠÙ†", "Ø£Ù„Ø«Ù„Ø§Ø«Ø§Ø¡", "Ø§Ù„Ø£Ø±Ø¨Ø¹Ø§Ø¡", "Ø£Ù„Ø­Ù…ÙŠØ³", "Ø£Ù„Ø¬Ù…Ø¹Ø©", "Ø§Ù„Ø³Ø¨Øª"], day_short: ["Ø§Ø­Ø¯", "Ø§Ø«Ù†ÙŠÙ†", "Ø«Ù„Ø§Ø«Ø§Ø¡", "Ø§Ø±Ø¨Ø¹Ø§Ø¡", "Ø®Ù…ÙŠØ³", "Ø¬Ù…Ø¹Ø©", "Ø³Ø¨Øª"] }, labels: { dhx_cal_today_button: "Ø§Ù„ÙŠÙˆÙ…", day_tab: "ÙŠÙˆÙ…", week_tab: "Ø£Ø³Ø¨ÙˆØ¹", month_tab: "Ø´Ù‡Ø±", new_event: "Ø­Ø¯Ø« Ø¬Ø¯ÙŠØ¯", icon_save: "Ø§Ø®Ø²Ù†", icon_cancel: "Ø§Ù„ØºØ§Ø¡", icon_details: "ØªÙØ§ØµÙŠÙ„", icon_edit: "ØªØ­Ø±ÙŠØ±", icon_delete: "Ø­Ø°Ù", confirm_closing: "Ø§Ù„ØªØºÙŠÙŠØ±Ø§Øª Ø³ÙˆÙ ØªØ¶ÙŠØ¹, Ù‡Ù„ Ø§Ù†Øª Ù…ØªØ£ÙƒØ¯ØŸ", confirm_deleting: "Ø§Ù„Ø­Ø¯Ø« Ø³ÙŠØªÙ… Ø­Ø°ÙÙ‡Ø§ Ù†Ù‡Ø§Ø¦ÙŠØ§ ØŒ Ù‡Ù„ Ø£Ù†Øª Ù…ØªØ£ÙƒØ¯ØŸ", section_description: "Ø§Ù„ÙˆØµÙ", section_time: "Ø§Ù„ÙØªØ±Ø© Ø§Ù„Ø²Ù…Ù†ÙŠØ©", full_day: "Ø·ÙˆØ§Ù„ Ø§Ù„ÙŠÙˆÙ…", confirm_recurring: "Ù‡Ù„ ØªØ±ÙŠØ¯ ØªØ­Ø±ÙŠØ± Ù…Ø¬Ù…ÙˆØ¹Ø© ÙƒØ§Ù…Ù„Ø© Ù…Ù† Ø§Ù„Ø£Ø­Ø¯Ø§Ø« Ø§Ù„Ù…ØªÙƒØ±Ø±Ø©ØŸ", section_recurring: "ØªÙƒØ±Ø§Ø± Ø§Ù„Ø­Ø¯Ø«", button_recurring: "ØªØ¹Ø·ÙŠÙ„", button_recurring_open: "ØªÙ…ÙƒÙŠÙ†", button_edit_series: "ØªØ­Ø±ÙŠØ± Ø³Ù„Ø³Ù„Ø©", button_edit_occurrence: "ØªØ¹Ø¯ÙŠÙ„ Ù†Ø³Ø®Ø©", button_edit_occurrence_and_following: "This and following events", grid_tab: "Ø¬Ø¯ÙˆÙ„", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "ÙŠÙˆÙ…ÙŠ", repeat_radio_week: "Ø£Ø³Ø¨ÙˆØ¹ÙŠ", repeat_radio_month: "Ø´Ù‡Ø±ÙŠ", repeat_radio_year: "Ø³Ù†ÙˆÙŠ", repeat_radio_day_type: "ÙƒÙ„", repeat_text_day_count: "ÙŠÙˆÙ…", repeat_radio_day_type2: "ÙƒÙ„ ÙŠÙˆÙ… Ø¹Ù…Ù„", repeat_week: " ØªÙƒØ±Ø§Ø± ÙƒÙ„", repeat_text_week_count: "Ø£Ø³Ø¨ÙˆØ¹ ÙÙŠ Ø§Ù„Ø£ÙŠØ§Ù… Ø§Ù„ØªØ§Ù„ÙŠØ©:", repeat_radio_month_type: "ØªÙƒØ±Ø§Ø±", repeat_radio_month_start: "ÙÙŠ", repeat_text_month_day: "ÙŠÙˆÙ… ÙƒÙ„", repeat_text_month_count: "Ø´Ù‡Ø±", repeat_text_month_count2_before: "ÙƒÙ„", repeat_text_month_count2_after: "Ø´Ù‡Ø±", repeat_year_label: "ÙÙŠ", select_year_day2: "Ù…Ù†", repeat_text_year_day: "ÙŠÙˆÙ…", select_year_month: "Ø´Ù‡Ø±", repeat_radio_end: "Ø¨Ø¯ÙˆÙ† ØªØ§Ø±ÙŠØ® Ø§Ù†ØªÙ‡Ø§Ø¡", repeat_text_occurrences_count: "ØªÙƒØ±Ø§Ø±Ø§Øª", repeat_radio_end2: "Ø¨Ø¹Ø¯", repeat_radio_end3: "ÙŠÙ†ØªÙ‡ÙŠ ÙÙŠ", repeat_never: "Ø£Ø¨Ø¯Ø§Ù‹", repeat_daily: "ÙƒÙ„ ÙŠÙˆÙ…", repeat_workdays: "ÙƒÙ„ ÙŠÙˆÙ… Ø¹Ù…Ù„", repeat_weekly: "ÙƒÙ„ Ø£Ø³Ø¨ÙˆØ¹", repeat_monthly: "ÙƒÙ„ Ø´Ù‡Ø±", repeat_yearly: "ÙƒÙ„ Ø³Ù†Ø©", repeat_custom: "ØªØ®ØµÙŠØµ", repeat_freq_day: "ÙŠÙˆÙ…", repeat_freq_week: "Ø£Ø³Ø¨ÙˆØ¹", repeat_freq_month: "Ø´Ù‡Ø±", repeat_freq_year: "Ø³Ù†Ø©", repeat_on_date: "ÙÙŠ Ø§Ù„ØªØ§Ø±ÙŠØ®", repeat_ends: "ÙŠÙ†ØªÙ‡ÙŠ", month_for_recurring: ["ÙŠÙ†Ø§ÙŠØ±", "ÙØ¨Ø±Ø§ÙŠØ±", "Ù…Ø§Ø±Ø³", "Ø£Ø¨Ø±ÙŠÙ„", "Ù…Ø§ÙŠÙˆ", "ÙŠÙˆÙ†ÙŠÙˆ", "ÙŠÙˆÙ„ÙŠÙˆ", "Ø£ØºØ³Ø·Ø³", "Ø³Ø¨ØªÙ…Ø¨Ø±", "Ø£ÙƒØªÙˆØ¨Ø±", "Ù†ÙˆÙÙ…Ø¨Ø±", "Ø¯ÙŠØ³Ù…Ø¨Ø±"], day_for_recurring: ["Ø§Ù„Ø£Ø­Ø¯", "Ø§Ù„Ø¥Ø«Ù†ÙŠÙ†", "Ø§Ù„Ø«Ù„Ø§Ø«Ø§Ø¡", "Ø§Ù„Ø£Ø±Ø¨Ø¹Ø§Ø¡", "Ø§Ù„Ø®Ù…ÙŠØ³", "Ø§Ù„Ø¬Ù…Ø¹Ø©", "Ø§Ù„Ø³Ø¨Øª"] } };
  const be = { date: { month_full: ["Ð¡Ñ‚ÑƒÐ´Ð·ÐµÐ½ÑŒ", "Ð›ÑŽÑ‚Ñ‹", "Ð¡Ð°ÐºÐ°Ð²Ñ–Ðº", "ÐšÑ€Ð°ÑÐ°Ð²Ñ–Ðº", "MaÐ¹", "Ð§ÑÑ€Ð²ÐµÐ½ÑŒ", "Ð›Ñ–Ð¿ÐµÐ½ÑŒ", "Ð–Ð½Ñ–Ð²ÐµÐ½ÑŒ", "Ð’ÐµÑ€Ð°ÑÐµÐ½ÑŒ", "ÐšÐ°ÑÑ‚Ñ€Ñ‹Ñ‡Ð½Ñ–Ðº", "Ð›Ñ–ÑÑ‚Ð°Ð¿Ð°Ð´", "Ð¡Ð½ÐµÐ¶Ð°Ð½ÑŒ"], month_short: ["Ð¡Ñ‚ÑƒÐ´Ð·", "Ð›ÑŽÑ‚", "Ð¡Ð°Ðº", "ÐšÑ€Ð°Ñ", "MaÐ¹", "Ð§ÑÑ€", "Ð›Ñ–Ð¿", "Ð–Ð½Ñ–Ð²", "Ð’ÐµÑ€", "ÐšÐ°ÑÑ‚", "Ð›Ñ–ÑÑ‚", "Ð¡Ð½ÐµÐ¶"], day_full: ["ÐÑÐ´Ð·ÐµÐ»Ñ", "ÐŸÐ°Ð½ÑÐ´Ð·ÐµÐ»Ð°Ðº", "ÐÑžÑ‚Ð¾Ñ€Ð°Ðº", "Ð¡ÐµÑ€Ð°Ð´Ð°", "Ð§Ð°Ñ†Ð²ÐµÑ€", "ÐŸÑÑ‚Ð½Ñ–Ñ†Ð°", "Ð¡ÑƒÐ±Ð¾Ñ‚Ð°"], day_short: ["ÐÐ´", "ÐŸÐ½", "ÐÑžÑ‚", "Ð¡Ñ€", "Ð§Ñ†Ð²", "ÐŸÑ‚", "Ð¡Ð±"] }, labels: { dhx_cal_today_button: "Ð¡Ñ‘Ð½Ð½Ñ", day_tab: "Ð”Ð·ÐµÐ½ÑŒ", week_tab: "Ð¢Ñ‹Ð´Ð·ÐµÐ½ÑŒ", month_tab: "ÐœÐµÑÑÑ†", new_event: "ÐÐ¾Ð²Ð°Ñ Ð¿Ð°Ð´Ð·ÐµÑ", icon_save: "Ð—Ð°Ñ…Ð°Ð²Ð°Ñ†ÑŒ", icon_cancel: "ÐÐ´Ð¼ÑÐ½Ñ–Ñ†ÑŒ", icon_details: "Ð”ÑÑ‚Ð°Ð»Ñ–", icon_edit: "Ð—Ð¼ÑÐ½Ñ–Ñ†ÑŒ", icon_delete: "Ð’Ñ‹Ð´Ð°Ð»Ñ–Ñ†ÑŒ", confirm_closing: "", confirm_deleting: "ÐŸÐ°Ð´Ð·ÐµÑ Ð±ÑƒÐ´Ð·Ðµ Ð²Ñ‹Ð´Ð°Ð»ÐµÐ½Ð° Ð½ÐµÐ·Ð²Ð°Ñ€Ð¾Ñ‚Ð½Ð°, Ð¿Ñ€Ð°Ñ†ÑÐ³Ð½ÑƒÑ†ÑŒ?", section_description: "ÐÐ¿Ñ–ÑÐ°Ð½Ð½Ðµ", section_time: "ÐŸÐµÑ€Ñ‹ÑÐ´ Ñ‡Ð°ÑÑƒ", full_day: "Ð£Ð²ÐµÑÑŒ Ð´Ð·ÐµÐ½ÑŒ", confirm_recurring: "Ð’Ñ‹ Ñ…Ð¾Ñ‡Ð°Ñ†Ðµ Ð·Ð¼ÑÐ½Ñ–Ñ†ÑŒ ÑƒÑÑŽ ÑÐµÑ€Ñ‹ÑŽ Ð¿Ð°ÑžÑ‚Ð°Ñ€Ð°Ð»ÑŒÐ½Ñ‹Ñ… Ð¿Ð°Ð´Ð·ÐµÐ¹?", section_recurring: "ÐŸÐ°ÑžÑ‚Ð°Ñ€ÑÐ½Ð½Ðµ", button_recurring: "ÐÐ´ÐºÐ»ÑŽÑ‡Ð°Ð½Ð°", button_recurring_open: "Ð£ÐºÐ»ÑŽÑ‡Ð°Ð½Ð°", button_edit_series: "Ð ÑÐ´Ð°Ð³Ð°Ð²Ð°Ñ†ÑŒ ÑÐµÑ€Ñ‹ÑŽ", button_edit_occurrence: "Ð ÑÐ´Ð°Ð³Ð°Ð²Ð°Ñ†ÑŒ Ð°ÑÐ¾Ð±Ð½Ñ–Ðº", button_edit_occurrence_and_following: "This and following events", agenda_tab: "Ð¡Ð¿Ñ–Ñ", date: "Ð”Ð°Ñ‚Ð°", description: "ÐÐ¿Ñ–ÑÐ°Ð½Ð½Ðµ", year_tab: "Ð“Ð¾Ð´", week_agenda_tab: "Ð¡Ð¿Ñ–Ñ", grid_tab: "Ð¡Ð¿ic", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "Ð”Ð·ÐµÐ½ÑŒ", repeat_radio_week: "Ð¢Ñ‹Ð´Ð·ÐµÐ½ÑŒ", repeat_radio_month: "ÐœÐµÑÑÑ†", repeat_radio_year: "Ð“Ð¾Ð´", repeat_radio_day_type: "ÐšÐ¾Ð¶Ð½Ñ‹", repeat_text_day_count: "Ð´Ð·ÐµÐ½ÑŒ", repeat_radio_day_type2: "ÐšÐ¾Ð¶Ð½Ñ‹ Ð¿Ñ€Ð°Ñ†Ð¾ÑžÐ½Ñ‹ Ð´Ð·ÐµÐ½ÑŒ", repeat_week: " ÐŸÐ°ÑžÑ‚Ð°Ñ€Ð°Ñ†ÑŒ ÐºÐ¾Ð¶Ð½Ñ‹", repeat_text_week_count: "Ñ‚Ñ‹Ð´Ð·ÐµÐ½ÑŒ", repeat_radio_month_type: "ÐŸÐ°ÑžÑ‚Ð°Ñ€Ð°Ñ†ÑŒ", repeat_radio_month_start: "", repeat_text_month_day: " Ñ‡Ñ‹ÑÐ»Ð° ÐºÐ¾Ð¶Ð½Ð°Ð³Ð°", repeat_text_month_count: "Ð¼ÐµÑÑÑ†Ñƒ", repeat_text_month_count2_before: "ÐºÐ¾Ð¶Ð½Ñ‹ ", repeat_text_month_count2_after: "Ð¼ÐµÑÑÑ†", repeat_year_label: "", select_year_day2: "", repeat_text_year_day: "Ð´Ð·ÐµÐ½ÑŒ", select_year_month: "", repeat_radio_end: "Ð‘ÐµÐ· Ð´Ð°Ñ‚Ñ‹ Ð·Ð°ÐºÐ°Ð½Ñ‡ÑÐ½Ð½Ñ", repeat_text_occurrences_count: "Ð¿Ð°ÑžÑ‚Ð¾Ñ€Ð°Ñž", repeat_radio_end2: "", repeat_radio_end3: "Ð”Ð° ", repeat_never: "ÐÑ–ÐºÐ¾Ð»Ñ–", repeat_daily: "ÐšÐ¾Ð¶Ð½Ñ‹ Ð´Ð·ÐµÐ½ÑŒ", repeat_workdays: "ÐšÐ¾Ð¶Ð½Ñ‹ Ð¿Ñ€Ð°Ñ†Ð¾ÑžÐ½Ñ‹ Ð´Ð·ÐµÐ½ÑŒ", repeat_weekly: "ÐšÐ¾Ð¶Ð½Ñ‹ Ñ‚Ñ‹Ð´Ð·ÐµÐ½ÑŒ", repeat_monthly: "ÐšÐ¾Ð¶Ð½Ñ‹ Ð¼ÐµÑÑÑ†", repeat_yearly: "ÐšÐ¾Ð¶Ð½Ñ‹ Ð³Ð¾Ð´", repeat_custom: "ÐÐ°Ð»Ð°Ð´Ð¶Ð²Ð°Ð»ÑŒÐ½Ñ‹", repeat_freq_day: "Ð”Ð·ÐµÐ½ÑŒ", repeat_freq_week: "Ð¢Ñ‹Ð´Ð·ÐµÐ½ÑŒ", repeat_freq_month: "ÐœÐµÑÑÑ†", repeat_freq_year: "Ð“Ð¾Ð´", repeat_on_date: "ÐÐ° Ð´Ð°Ñ‚Ñƒ", repeat_ends: "Ð—Ð°ÐºÐ°Ð½Ñ‡Ð²Ð°ÐµÑ†Ñ†Ð°", month_for_recurring: ["Ð¡Ñ‚ÑƒÐ´Ð·ÐµÐ½Ñ", "Ð›ÑŽÑ‚Ð°Ð³Ð°", "Ð¡Ð°ÐºÐ°Ð²Ñ–ÐºÐ°", "ÐšÑ€Ð°ÑÐ°Ð²Ñ–ÐºÐ°", "ÐœÐ°Ñ", "Ð§ÑÑ€Ð²ÐµÐ½Ñ", "Ð›Ñ–Ð¿eÐ½Ñ", "Ð–Ð½Ñ–ÑžÐ½Ñ", "Ð’ÐµÑ€Ð°ÑÐ½Ñ", "ÐšÐ°ÑÑ‚Ñ€Ñ‹Ñ‡Ð½Ñ–ÐºÐ°", "Ð›Ñ–ÑÑ‚Ð°Ð¿Ð°Ð´Ð°", "Ð¡Ð½ÐµÐ¶Ð½Ñ"], day_for_recurring: ["ÐÑÐ´Ð·ÐµÐ»ÑŽ", "ÐŸÐ°Ð½ÑÐ´Ð·ÐµÐ»Ð°Ðº", "ÐÑžÑ‚Ð¾Ñ€Ð°Ðº", "Ð¡ÐµÑ€Ð°Ð´Ñƒ", "Ð§Ð°Ñ†Ð²ÐµÑ€", "ÐŸÑÑ‚Ð½Ñ–Ñ†Ñƒ", "Ð¡ÑƒÐ±Ð¾Ñ‚Ñƒ"] } };
  const ca = { date: { month_full: ["Gener", "Febrer", "MarÃ§", "Abril", "Maig", "Juny", "Juliol", "Agost", "Setembre", "Octubre", "Novembre", "Desembre"], month_short: ["Gen", "Feb", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Oct", "Nov", "Des"], day_full: ["Diumenge", "Dilluns", "Dimarts", "Dimecres", "Dijous", "Divendres", "Dissabte"], day_short: ["Dg", "Dl", "Dm", "Dc", "Dj", "Dv", "Ds"] }, labels: { dhx_cal_today_button: "Hui", day_tab: "Dia", week_tab: "Setmana", month_tab: "Mes", new_event: "Nou esdeveniment", icon_save: "Guardar", icon_cancel: "CancelÂ·lar", icon_details: "Detalls", icon_edit: "Editar", icon_delete: "Esborrar", confirm_closing: "", confirm_deleting: "L'esdeveniment s'esborrarÃ  definitivament, continuar ?", section_description: "DescripciÃ³", section_time: "Periode de temps", full_day: "Tot el dia", confirm_recurring: "Â¿Desitja modificar el conjunt d'esdeveniments repetits?", section_recurring: "Repeteixca l'esdeveniment", button_recurring: "Impedit", button_recurring_open: "PermÃ©s", button_edit_series: "Edit sÃ¨rie", button_edit_occurrence: "Edita InstÃ ncia", button_edit_occurrence_and_following: "This and following events", agenda_tab: "Agenda", date: "Data", description: "DescripciÃ³", year_tab: "Any", week_agenda_tab: "Agenda", grid_tab: "Taula", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "Diari", repeat_radio_week: "Setmanal", repeat_radio_month: "Mensual", repeat_radio_year: "Anual", repeat_radio_day_type: "Cada", repeat_text_day_count: "dia", repeat_radio_day_type2: "Cada dia laborable", repeat_week: " Repetir cada", repeat_text_week_count: "setmana els dies segÃ¼ents:", repeat_radio_month_type: "Repetir", repeat_radio_month_start: "El", repeat_text_month_day: "dia cada", repeat_text_month_count: "mes", repeat_text_month_count2_before: "cada", repeat_text_month_count2_after: "mes", repeat_year_label: "El", select_year_day2: "de", repeat_text_year_day: "dia", select_year_month: "mes", repeat_radio_end: "Sense data de finalitzaciÃ³", repeat_text_occurrences_count: "ocurrÃ¨ncies", repeat_radio_end2: "DesprÃ©s", repeat_radio_end3: "Finalitzar el", repeat_never: "Mai", repeat_daily: "Cada dia", repeat_workdays: "Cada dia laborable", repeat_weekly: "Cada setmana", repeat_monthly: "Cada mes", repeat_yearly: "Cada any", repeat_custom: "Personalitzat", repeat_freq_day: "Dia", repeat_freq_week: "Setmana", repeat_freq_month: "Mes", repeat_freq_year: "Any", repeat_on_date: "En la data", repeat_ends: "Finalitza", month_for_recurring: ["Gener", "Febrer", "MarÃ§", "Abril", "Maig", "Juny", "Juliol", "Agost", "Setembre", "Octubre", "Novembre", "Desembre"], day_for_recurring: ["Diumenge", "Dilluns", "Dimarts", "Dimecres", "Dijous", "Divendres", "Dissabte"] } };
  const cn = { date: { month_full: ["ä¸€æœˆ", "äºŒæœˆ", "ä¸‰æœˆ", "å››æœˆ", "äº”æœˆ", "å…­æœˆ", "ä¸ƒæœˆ", "å…«æœˆ", "ä¹æœˆ", "åæœˆ", "åä¸€æœˆ", "åäºŒæœˆ"], month_short: ["1æœˆ", "2æœˆ", "3æœˆ", "4æœˆ", "5æœˆ", "6æœˆ", "7æœˆ", "8æœˆ", "9æœˆ", "10æœˆ", "11æœˆ", "12æœˆ"], day_full: ["æ˜ŸæœŸæ—¥", "æ˜ŸæœŸä¸€", "æ˜ŸæœŸäºŒ", "æ˜ŸæœŸä¸‰", "æ˜ŸæœŸå››", "æ˜ŸæœŸäº”", "æ˜ŸæœŸå…­"], day_short: ["æ—¥", "ä¸€", "äºŒ", "ä¸‰", "å››", "äº”", "å…­"] }, labels: { dhx_cal_today_button: "ä»Šå¤©", day_tab: "æ—¥", week_tab: "å‘¨", month_tab: "æœˆ", new_event: "æ–°å»ºæ—¥ç¨‹", icon_save: "ä¿å­˜", icon_cancel: "å…³é—­", icon_details: "è¯¦ç»†", icon_edit: "ç¼–è¾‘", icon_delete: "åˆ é™¤", confirm_closing: "è¯·ç¡®è®¤æ˜¯å¦æ’¤é”€ä¿®æ”¹!", confirm_deleting: "æ˜¯å¦åˆ é™¤æ—¥ç¨‹?", section_description: "æè¿°", section_time: "æ—¶é—´èŒƒå›´", full_day: "æ•´å¤©", confirm_recurring: "è¯·ç¡®è®¤æ˜¯å¦å°†æ—¥ç¨‹è®¾ä¸ºé‡å¤æ¨¡å¼?", section_recurring: "é‡å¤å‘¨æœŸ", button_recurring: "ç¦ç”¨", button_recurring_open: "å¯ç”¨", button_edit_series: "ç¼–è¾‘ç³»åˆ—", button_edit_occurrence: "ç¼–è¾‘å®žä¾‹", button_edit_occurrence_and_following: "This and following events", agenda_tab: "è®®ç¨‹", date: "æ—¥æœŸ", description: "è¯´æ˜Ž", year_tab: "ä»Šå¹´", week_agenda_tab: "è®®ç¨‹", grid_tab: "ç”µç½‘", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "æŒ‰å¤©", repeat_radio_week: "æŒ‰å‘¨", repeat_radio_month: "æŒ‰æœˆ", repeat_radio_year: "æŒ‰å¹´", repeat_radio_day_type: "æ¯", repeat_text_day_count: "å¤©", repeat_radio_day_type2: "æ¯ä¸ªå·¥ä½œæ—¥", repeat_week: " é‡å¤ æ¯", repeat_text_week_count: "æ˜ŸæœŸçš„:", repeat_radio_month_type: "é‡å¤", repeat_radio_month_start: "åœ¨", repeat_text_month_day: "æ—¥ æ¯", repeat_text_month_count: "æœˆ", repeat_text_month_count2_before: "æ¯", repeat_text_month_count2_after: "æœˆ", repeat_year_label: "åœ¨", select_year_day2: "çš„", repeat_text_year_day: "æ—¥", select_year_month: "æœˆ", repeat_radio_end: "æ— ç»“æŸæ—¥æœŸ", repeat_text_occurrences_count: "æ¬¡ç»“æŸ", repeat_radio_end2: "é‡å¤", repeat_radio_end3: "ç»“æŸäºŽ", repeat_never: "ä»Žä¸", repeat_daily: "æ¯å¤©", repeat_workdays: "æ¯ä¸ªå·¥ä½œæ—¥", repeat_weekly: "æ¯å‘¨", repeat_monthly: "æ¯æœˆ", repeat_yearly: "æ¯å¹´", repeat_custom: "è‡ªå®šä¹‰", repeat_freq_day: "å¤©", repeat_freq_week: "å‘¨", repeat_freq_month: "æœˆ", repeat_freq_year: "å¹´", repeat_on_date: "åœ¨æ—¥æœŸ", repeat_ends: "ç»“æŸ", month_for_recurring: ["ä¸€æœˆ", "äºŒæœˆ", "ä¸‰æœˆ", "å››æœˆ", "äº”æœˆ", "å…­æœˆ", "ä¸ƒæœˆ", "å…«æœˆ", "ä¹æœˆ", "åæœˆ", "åä¸€æœˆ", "åäºŒæœˆ"], day_for_recurring: ["æ˜ŸæœŸæ—¥", "æ˜ŸæœŸä¸€", "æ˜ŸæœŸäºŒ", "æ˜ŸæœŸä¸‰", "æ˜ŸæœŸå››", "æ˜ŸæœŸäº”", "æ˜ŸæœŸå…­"] } };
  const cs = { date: { month_full: ["Leden", "Ãšnor", "BÅ™ezen", "Duben", "KvÄ›ten", "ÄŒerven", "ÄŒervenec", "Srpen", "ZÃ¡Å™Ã­", "Å˜Ã­jen", "Listopad", "Prosinec"], month_short: ["Led", "Ãšn", "BÅ™e", "Dub", "KvÄ›", "ÄŒer", "ÄŒec", "Srp", "ZÃ¡Å™Ã­", "Å˜Ã­j", "List", "Pro"], day_full: ["NedÄ›le", "PondÄ›lÃ­", "ÃšterÃ½", "StÅ™eda", "ÄŒtvrtek", "PÃ¡tek", "Sobota"], day_short: ["Ne", "Po", "Ãšt", "St", "ÄŒt", "PÃ¡", "So"] }, labels: { dhx_cal_today_button: "Dnes", day_tab: "Den", week_tab: "TÃ½den", month_tab: "MÄ›sÃ­c", new_event: "NovÃ¡ udÃ¡lost", icon_save: "UloÅ¾it", icon_cancel: "ZpÄ›t", icon_details: "Detail", icon_edit: "Edituj", icon_delete: "Smazat", confirm_closing: "", confirm_deleting: "UdÃ¡lost bude trvale smazÃ¡na, opravdu?", section_description: "PoznÃ¡mky", section_time: "Doba platnosti", confirm_recurring: "PÅ™ejete si upravit celou Å™adu opakovanÃ½ch udÃ¡lostÃ­?", section_recurring: "OpakovÃ¡nÃ­ udÃ¡losti", button_recurring: "Vypnuto", button_recurring_open: "Zapnuto", button_edit_series: "Edit series", button_edit_occurrence: "Upravit instance", button_edit_occurrence_and_following: "This and following events", agenda_tab: "Program", date: "Datum", description: "PoznÃ¡mka", year_tab: "Rok", full_day: "Full day", week_agenda_tab: "Program", grid_tab: "MÅ™Ã­Å¾ka", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "DennÄ›", repeat_radio_week: "TÃ½dnÄ›", repeat_radio_month: "MÄ›sÃ­ÄnÄ›", repeat_radio_year: "RoÄnÄ›", repeat_radio_day_type: "kaÅ¾dÃ½", repeat_text_day_count: "Den", repeat_radio_day_type2: "pracovnÃ­ dny", repeat_week: "Opakuje kaÅ¾dÃ½ch", repeat_text_week_count: "TÃ½dnÅ¯ na:", repeat_radio_month_type: "u kaÅ¾dÃ©ho", repeat_radio_month_start: "na", repeat_text_month_day: "Den kaÅ¾dÃ©ho", repeat_text_month_count: "MÄ›sÃ­c", repeat_text_month_count2_before: "kaÅ¾dÃ½", repeat_text_month_count2_after: "MÄ›sÃ­c", repeat_year_label: "na", select_year_day2: "v", repeat_text_year_day: "Den v", select_year_month: "", repeat_radio_end: "bez data ukonÄenÃ­", repeat_text_occurrences_count: "UdÃ¡losti", repeat_radio_end2: "po", repeat_radio_end3: "Konec", repeat_never: "Nikdy", repeat_daily: "KaÅ¾dÃ½ den", repeat_workdays: "KaÅ¾dÃ½ pracovnÃ­ den", repeat_weekly: "KaÅ¾dÃ½ tÃ½den", repeat_monthly: "KaÅ¾dÃ½ mÄ›sÃ­c", repeat_yearly: "KaÅ¾dÃ½ rok", repeat_custom: "VlastnÃ­", repeat_freq_day: "Den", repeat_freq_week: "TÃ½den", repeat_freq_month: "MÄ›sÃ­c", repeat_freq_year: "Rok", repeat_on_date: "Na datum", repeat_ends: "KonÄÃ­", month_for_recurring: ["Leden", "Ãšnor", "BÅ™ezen", "Duben", "KvÄ›ten", "ÄŒerven", "ÄŒervenec", "Srpen", "ZÃ¡Å™Ã­", "Å˜Ã­jen", "Listopad", "Prosinec"], day_for_recurring: ["NedÄ›le ", "PondÄ›lÃ­", "ÃšterÃ½", "StÅ™eda", "ÄŒtvrtek", "PÃ¡tek", "Sobota"] } };
  const da = { date: { month_full: ["Januar", "Februar", "Marts", "April", "Maj", "Juni", "Juli", "August", "September", "Oktober", "November", "December"], month_short: ["Jan", "Feb", "Mar", "Apr", "Maj", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dec"], day_full: ["SÃ¸ndag", "Mandag", "Tirsdag", "Onsdag", "Torsdag", "Fredag", "LÃ¸rdag"], day_short: ["SÃ¸n", "Man", "Tir", "Ons", "Tor", "Fre", "LÃ¸r"] }, labels: { dhx_cal_today_button: "Idag", day_tab: "Dag", week_tab: "Uge", month_tab: "MÃ¥ned", new_event: "Ny begivenhed", icon_save: "Gem", icon_cancel: "Fortryd", icon_details: "Detaljer", icon_edit: "Tilret", icon_delete: "Slet", confirm_closing: "Dine rettelser vil gÃ¥ tabt.. Er dy sikker?", confirm_deleting: "Bigivenheden vil blive slettet permanent. Er du sikker?", section_description: "Beskrivelse", section_time: "Tidsperiode", confirm_recurring: "Vil du tilrette hele serien af gentagne begivenheder?", section_recurring: "Gentag begivenhed", button_recurring: "Frakoblet", button_recurring_open: "Tilkoblet", button_edit_series: "Rediger serien", button_edit_occurrence: "Rediger en kopi", button_edit_occurrence_and_following: "This and following events", agenda_tab: "Dagsorden", date: "Dato", description: "Beskrivelse", year_tab: "Ã…r", week_agenda_tab: "Dagsorden", grid_tab: "Grid", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "Daglig", repeat_radio_week: "Ugenlig", repeat_radio_month: "MÃ¥nedlig", repeat_radio_year: "Ã…rlig", repeat_radio_day_type: "Hver", repeat_text_day_count: "dag", repeat_radio_day_type2: "PÃ¥ hver arbejdsdag", repeat_week: " Gentager sig hver", repeat_text_week_count: "uge pÃ¥ fÃ¸lgende dage:", repeat_radio_month_type: "Hver den", repeat_radio_month_start: "Den", repeat_text_month_day: " i hver", repeat_text_month_count: "mÃ¥ned", repeat_text_month_count2_before: "hver", repeat_text_month_count2_after: "mÃ¥ned", repeat_year_label: "Den", select_year_day2: "i", repeat_text_year_day: "dag i", select_year_month: "", repeat_radio_end: "Ingen slutdato", repeat_text_occurrences_count: "gentagelse", repeat_radio_end2: "Efter", repeat_radio_end3: "Slut", repeat_never: "Aldrig", repeat_daily: "Hver dag", repeat_workdays: "Hver hverdag", repeat_weekly: "Hver uge", repeat_monthly: "Hver mÃ¥ned", repeat_yearly: "Hvert Ã¥r", repeat_custom: "Brugerdefineret", repeat_freq_day: "Dag", repeat_freq_week: "Uge", repeat_freq_month: "MÃ¥ned", repeat_freq_year: "Ã…r", repeat_on_date: "PÃ¥ dato", repeat_ends: "Slutter", month_for_recurring: ["Januar", "Februar", "MÃ¤rz", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"], day_for_recurring: ["SÃ¸ndag", "Mandag", "Tirsdag", "Onsdag", "Torsdag", "Fredag", "LÃ¸rdag"] } };
  const de = { date: { month_full: [" Januar", " Februar", " MÃ¤rz ", " April", " Mai", " Juni", " Juli", " August", " September ", " Oktober", " November ", " Dezember"], month_short: ["Jan", "Feb", "MÃ¤r", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dez"], day_full: ["Sonntag", "Montag", "Dienstag", " Mittwoch", " Donnerstag", "Freitag", "Samstag"], day_short: ["So", "Mo", "Di", "Mi", "Do", "Fr", "Sa"] }, labels: { dhx_cal_today_button: "Heute", day_tab: "Tag", week_tab: "Woche", month_tab: "Monat", new_event: "neuer Eintrag", icon_save: "Speichern", icon_cancel: "Abbrechen", icon_details: "Details", icon_edit: "Ã„ndern", icon_delete: "LÃ¶schen", confirm_closing: "", confirm_deleting: "Der Eintrag wird gelÃ¶scht", section_description: "Beschreibung", section_time: "Zeitspanne", full_day: "Ganzer Tag", confirm_recurring: "Wollen Sie alle EintrÃ¤ge bearbeiten oder nur diesen einzelnen Eintrag?", section_recurring: "Wiederholung", button_recurring: "Aus", button_recurring_open: "An", button_edit_series: "Bearbeiten Sie die Serie", button_edit_occurrence: "Bearbeiten Sie eine Kopie", button_edit_occurrence_and_following: "This and following events", agenda_tab: "Agenda", date: "Datum", description: "Beschreibung", year_tab: "Jahre", week_agenda_tab: "Agenda", grid_tab: "Grid", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "TÃ¤glich", repeat_radio_week: "WÃ¶chentlich", repeat_radio_month: "Monatlich", repeat_radio_year: "JÃ¤hrlich", repeat_radio_day_type: "jeden", repeat_text_day_count: "Tag", repeat_radio_day_type2: "an jedem Arbeitstag", repeat_week: " Wiederholt sich jede", repeat_text_week_count: "Woche am:", repeat_radio_month_type: "an jedem", repeat_radio_month_start: "am", repeat_text_month_day: "Tag eines jeden", repeat_text_month_count: "Monats", repeat_text_month_count2_before: "jeden", repeat_text_month_count2_after: "Monats", repeat_year_label: "am", select_year_day2: "im", repeat_text_year_day: "Tag im", select_year_month: "", repeat_radio_end: "kein Enddatum", repeat_text_occurrences_count: "Ereignissen", repeat_radio_end3: "SchluÃŸ", repeat_radio_end2: "nach", repeat_never: "Nie", repeat_daily: "Jeden Tag", repeat_workdays: "Jeden Werktag", repeat_weekly: "Jede Woche", repeat_monthly: "Jeden Monat", repeat_yearly: "Jedes Jahr", repeat_custom: "Benutzerdefiniert", repeat_freq_day: "Tag", repeat_freq_week: "Woche", repeat_freq_month: "Monat", repeat_freq_year: "Jahr", repeat_on_date: "Am Datum", repeat_ends: "Endet", month_for_recurring: ["Januar", "Februar", "MÃ¤rz", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"], day_for_recurring: ["Sonntag", "Montag", "Dienstag", "Mittwoch", "Donnerstag", "Freitag", "Samstag"] } };
  const el = { date: { month_full: ["Î™Î±Î½Î¿Ï…Î¬ÏÎ¹Î¿Ï‚", "Î¦ÎµÎ²ÏÎ¿Ï…Î¬ÏÎ¹Î¿Ï‚", "ÎœÎ¬ÏÏ„Î¹Î¿Ï‚", "Î‘Ï€ÏÎ¯Î»Î¹Î¿Ï‚", "ÎœÎ¬ÏŠÎ¿Ï‚", "Î™Î¿ÏÎ½Î¹Î¿Ï‚", "Î™Î¿ÏÎ»Î¹Î¿Ï‚", "Î‘ÏÎ³Î¿Ï…ÏƒÏ„Î¿Ï‚", "Î£ÎµÏ€Ï„Î­Î¼Î²ÏÎ¹Î¿Ï‚", "ÎŸÎºÏ„ÏŽÎ²ÏÎ¹Î¿Ï‚", "ÎÎ¿Î­Î¼Î²ÏÎ¹Î¿Ï‚", "Î”ÎµÎºÎ­Î¼Î²ÏÎ¹Î¿Ï‚"], month_short: ["Î™Î‘Î", "Î¦Î•Î’", "ÎœÎ‘Î¡", "Î‘Î Î¡", "ÎœÎ‘Î™", "Î™ÎŸÎ¥Î", "Î™ÎŸÎ¥Î›", "Î‘Î¥Î“", "Î£Î•Î ", "ÎŸÎšÎ¤", "ÎÎŸÎ•", "Î”Î•Îš"], day_full: ["ÎšÏ…ÏÎ¹Î±ÎºÎ®", "Î”ÎµÏ…Ï„Î­ÏÎ±", "Î¤ÏÎ¯Ï„Î·", "Î¤ÎµÏ„Î¬ÏÏ„Î·", "Î Î­Î¼Ï€Ï„Î·", "Î Î±ÏÎ±ÏƒÎºÎµÏ…Î®", "Î£Î¬Î²Î²Î±Ï„Î¿"], day_short: ["ÎšÎ¥", "Î”Î•", "Î¤Î¡", "Î¤Î•", "Î Î•", "Î Î‘", "Î£Î‘"] }, labels: { dhx_cal_today_button: "Î£Î®Î¼ÎµÏÎ±", day_tab: "Î—Î¼Î­ÏÎ±", week_tab: "Î•Î²Î´Î¿Î¼Î¬Î´Î±", month_tab: "ÎœÎ®Î½Î±Ï‚", new_event: "ÎÎ­Î¿ Î­ÏÎ³Î¿", icon_save: "Î‘Ï€Î¿Î¸Î®ÎºÎµÏ…ÏƒÎ·", icon_cancel: "Î†ÎºÏ…ÏÎ¿", icon_details: "Î›ÎµÏ€Ï„Î¿Î¼Î­ÏÎµÎ¹ÎµÏ‚", icon_edit: "Î•Ï€ÎµÎ¾ÎµÏÎ³Î±ÏƒÎ¯Î±", icon_delete: "Î”Î¹Î±Î³ÏÎ±Ï†Î®", confirm_closing: "", confirm_deleting: "Î¤Î¿ Î­ÏÎ³Î¿ Î¸Î± Î´Î¹Î±Î³ÏÎ±Ï†ÎµÎ¯ Î¿ÏÎ¹ÏƒÏ„Î¹ÎºÎ¬. Î˜Î­Î»ÎµÏ„Îµ Î½Î± ÏƒÏ…Î½ÎµÏ‡Î¯ÏƒÎµÏ„Îµ;", section_description: "Î ÎµÏÎ¹Î³ÏÎ±Ï†Î®", section_time: "Î§ÏÎ¿Î½Î¹ÎºÎ® Ï€ÎµÏÎ¯Î¿Î´Î¿Ï‚", full_day: "Î Î»Î®ÏÎ·Ï‚ Î—Î¼Î­ÏÎ±", confirm_recurring: "Î˜Î­Î»ÎµÏ„Îµ Î½Î± ÎµÏ€ÎµÎ¾ÎµÏÎ³Î±ÏƒÎ¸ÎµÎ¯Ï„Îµ Î¿Î»ÏŒÎºÎ»Î·ÏÎ· Ï„Î·Î½ Î¿Î¼Î¬Î´Î± Ï„Ï‰Î½ ÎµÏ€Î±Î½Î±Î»Î±Î¼Î²Î±Î½ÏŒÎ¼ÎµÎ½Ï‰Î½ Î­ÏÎ³Ï‰Î½;", section_recurring: "Î•Ï€Î±Î½Î±Î»Î±Î¼Î²Î±Î½ÏŒÎ¼ÎµÎ½Î¿ Î­ÏÎ³Î¿", button_recurring: "Î‘Î½ÎµÎ½ÎµÏÎ³ÏŒ", button_recurring_open: "Î•Î½ÎµÏÎ³ÏŒ", button_edit_series: "Î•Ï€ÎµÎ¾ÎµÏÎ³Î±ÏƒÏ„ÎµÎ¯Ï„Îµ Ï„Î· ÏƒÎµÎ¹ÏÎ¬", button_edit_occurrence: "Î•Ï€ÎµÎ¾ÎµÏÎ³Î±ÏƒÎ¯Î± Î­Î½Î± Î±Î½Ï„Î¯Î³ÏÎ±Ï†Î¿", button_edit_occurrence_and_following: "This and following events", agenda_tab: "Î—Î¼ÎµÏÎ®ÏƒÎ¹Î± Î”Î¹Î¬Ï„Î±Î¾Î·", date: "Î—Î¼ÎµÏÎ¿Î¼Î·Î½Î¯Î±", description: "Î ÎµÏÎ¹Î³ÏÎ±Ï†Î®", year_tab: "ÎˆÏ„Î¿Ï‚", week_agenda_tab: "Î—Î¼ÎµÏÎ®ÏƒÎ¹Î± Î”Î¹Î¬Ï„Î±Î¾Î·", grid_tab: "Î Î»Î­Î³Î¼Î±", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "Î—Î¼ÎµÏÎ·ÏƒÎ¯Ï‰Ï‚", repeat_radio_week: "Î•Î²Î´Î¿Î¼Î±Î´Î¹Î±Î¯Ï‰Ï‚", repeat_radio_month: "ÎœÎ·Î½Î¹Î±Î¯Ï‰Ï‚", repeat_radio_year: "Î•Ï„Î·ÏƒÎ¯Ï‰Ï‚", repeat_radio_day_type: "ÎšÎ¬Î¸Îµ", repeat_text_day_count: "Î·Î¼Î­ÏÎ±", repeat_radio_day_type2: "ÎšÎ¬Î¸Îµ ÎµÏÎ³Î¬ÏƒÎ¹Î¼Î·", repeat_week: " Î•Ï€Î±Î½Î¬Î»Î·ÏˆÎ· ÎºÎ¬Î¸Îµ", repeat_text_week_count: "ÎµÎ²Î´Î¿Î¼Î¬Î´Î± Ï„Î¹Ï‚ ÎµÏ€ÏŒÎ¼ÎµÎ½ÎµÏ‚ Î·Î¼Î­ÏÎµÏ‚:", repeat_radio_month_type: "Î•Ï€Î±Î½Î¬Î»Î·ÏˆÎ·", repeat_radio_month_start: "Î¤Î·Î½", repeat_text_month_day: "Î·Î¼Î­ÏÎ± ÎºÎ¬Î¸Îµ", repeat_text_month_count: "Î¼Î®Î½Î±", repeat_text_month_count2_before: "ÎºÎ¬Î¸Îµ", repeat_text_month_count2_after: "Î¼Î®Î½Î±", repeat_year_label: "Î¤Î·Î½", select_year_day2: "Ï„Î¿Ï…", repeat_text_year_day: "Î·Î¼Î­ÏÎ±", select_year_month: "Î¼Î®Î½Î±", repeat_radio_end: "Î§Ï‰ÏÎ¯Ï‚ Î·Î¼ÎµÏÎ¿Î¼Î·Î½Î¯Î± Î»Î®Î¾ÎµÏ‰Ï‚", repeat_text_occurrences_count: "ÎµÏ€Î±Î½Î±Î»Î®ÏˆÎµÎ¹Ï‚", repeat_radio_end3: "Î›Î®Î³ÎµÎ¹ Ï„Î·Î½", repeat_radio_end2: "ÎœÎµÏ„Î¬ Î±Ï€ÏŒ", repeat_never: "Î Î¿Ï„Î­", repeat_daily: "ÎšÎ¬Î¸Îµ Î¼Î­ÏÎ±", repeat_workdays: "ÎšÎ¬Î¸Îµ ÎµÏÎ³Î¬ÏƒÎ¹Î¼Î· Î¼Î­ÏÎ±", repeat_weekly: "ÎšÎ¬Î¸Îµ ÎµÎ²Î´Î¿Î¼Î¬Î´Î±", repeat_monthly: "ÎšÎ¬Î¸Îµ Î¼Î®Î½Î±", repeat_yearly: "ÎšÎ¬Î¸Îµ Ï‡ÏÏŒÎ½Î¿", repeat_custom: "Î ÏÎ¿ÏƒÎ±ÏÎ¼Î¿ÏƒÎ¼Î­Î½Î¿", repeat_freq_day: "Î—Î¼Î­ÏÎ±", repeat_freq_week: "Î•Î²Î´Î¿Î¼Î¬Î´Î±", repeat_freq_month: "ÎœÎ®Î½Î±Ï‚", repeat_freq_year: "Î§ÏÏŒÎ½Î¿Ï‚", repeat_on_date: "Î£Îµ Î·Î¼ÎµÏÎ¿Î¼Î·Î½Î¯Î±", repeat_ends: "Î›Î®Î³ÎµÎ¹", month_for_recurring: ["Î™Î±Î½Î¿Ï…Î¬ÏÎ¹Î¿Ï‚", "Î¦ÎµÎ²ÏÎ¿Ï…Î¬ÏÎ¹Î¿Ï‚", "ÎœÎ¬ÏÏ„Î¹Î¿Ï‚", "Î‘Ï€ÏÎ¯Î»Î¹Î¿Ï‚", "ÎœÎ¬ÏŠÎ¿Ï‚", "Î™Î¿ÏÎ½Î¹Î¿Ï‚", "Î™Î¿ÏÎ»Î¹Î¿Ï‚", "Î‘ÏÎ³Î¿Ï…ÏƒÏ„Î¿Ï‚", "Î£ÎµÏ€Ï„Î­Î¼Î²ÏÎ¹Î¿Ï‚", "ÎŸÎºÏ„ÏŽÎ²ÏÎ¹Î¿Ï‚", "ÎÎ¿Î­Î¼Î²ÏÎ¹Î¿Ï‚", "Î”ÎµÎºÎ­Î¼Î²ÏÎ¹Î¿Ï‚"], day_for_recurring: ["ÎšÏ…ÏÎ¹Î±ÎºÎ®", "Î”ÎµÏ…Ï„Î­ÏÎ±", "Î¤ÏÎ¯Ï„Î·", "Î¤ÎµÏ„Î¬ÏÏ„Î·", "Î Î­Î¼Ï€Ï„Î·", "Î Î±ÏÎ±ÏƒÎºÎµÏ…Î®", "Î£Î¬Î²Î²Î±Ï„Î¿"] } };
  ...
  const es = { date: { month_full: ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"], month_short: ["Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dic"], day_full: ["Domingo", "Lunes", "Martes", "MiÃ©rcoles", "Jueves", "Viernes", "SÃ¡bado"], day_short: ["Dom", "Lun", "Mar", "MiÃ©", "Jue", "Vie", "SÃ¡b"] }, labels: { dhx_cal_today_button: "Hoy", day_tab: "DÃ­a", week_tab: "Semana", month_tab: "Mes", new_event: "Nuevo evento", icon_save: "Guardar", icon_cancel: "Cancelar", icon_details: "Detalles", icon_edit: "Editar", icon_delete: "Eliminar", confirm_closing: "", confirm_deleting: "El evento se borrarÃ¡ definitivamente, Â¿continuar?", section_description: "DescripciÃ³n", section_time: "PerÃ­odo", full_day: "Todo el dÃ­a", confirm_recurring: "Â¿Desea modificar el conjunto de eventos repetidos?", section_recurring: "Repita el evento", button_recurring: "Impedido", button_recurring_open: "Permitido", button_edit_series: "Editar la serie", button_edit_occurrence: "Editar este evento", button_edit_occurrence_and_following: "This and following events", agenda_tab: "DÃ­a", date: "Fecha", description: "DescripciÃ³n", year_tab: "AÃ±o", week_agenda_tab: "DÃ­a", grid_tab: "Reja", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "Diariamente", repeat_radio_week: "Semanalmente", repeat_radio_month: "Mensualmente", repeat_radio_year: "Anualmente", repeat_radio_day_type: "Cada", repeat_text_day_count: "dia", repeat_radio_day_type2: "Cada jornada de trabajo", repeat_week: " Repetir cada", repeat_text_week_count: "semana:", repeat_radio_month_type: "Repita", repeat_radio_month_start: "El", repeat_text_month_day: "dia cada ", repeat_text_month_count: "mes", repeat_text_month_count2_before: "cada", repeat_text_month_count2_after: "mes", repeat_year_label: "El", select_year_day2: "del", repeat_text_year_day: "dia", select_year_month: "mes", repeat_radio_end: "Sin fecha de finalizaciÃ³n", repeat_text_occurrences_count: "ocurrencias", repeat_radio_end3: "Fin", repeat_radio_end2: "DespuÃ©s de", repeat_never: "Nunca", repeat_daily: "Cada dÃ­a", repeat_workdays: "Cada dÃ­a laborable", repeat_weekly: "Cada semana", repeat_monthly: "Cada mes", repeat_yearly: "Cada aÃ±o", repeat_custom: "Personalizado", repeat_freq_day: "DÃ­a", repeat_freq_week: "Semana", repeat_freq_month: "Mes", repeat_freq_year: "AÃ±o", repeat_on_date: "En la fecha", repeat_ends: "Termina", month_for_recurring: ["Enero", "Febrero", "ÐœÐ°rzo", "Ðbril", "Mayo", "Junio", "Julio", "Ðgosto", "Setiembre", "Octubre", "Noviembre", "Diciembre"], day_for_recurring: ["Domingo", "Lunes", "Martes", "MiÃ©rcoles", "Jeuves", "Viernes", "Sabado"] } };
  const fi = { date: { month_full: ["Tammikuu", "Helmikuu", "Maaliskuu", "Huhtikuu", "Toukokuu", "Kes&auml;kuu", "Hein&auml;kuu", "Elokuu", "Syyskuu", "Lokakuu", "Marraskuu", "Joulukuu"], month_short: ["Tam", "Hel", "Maa", "Huh", "Tou", "Kes", "Hei", "Elo", "Syy", "Lok", "Mar", "Jou"], day_full: ["Sunnuntai", "Maanantai", "Tiistai", "Keskiviikko", "Torstai", "Perjantai", "Lauantai"], day_short: ["Su", "Ma", "Ti", "Ke", "To", "Pe", "La"] }, labels: { dhx_cal_today_button: "TÃ¤nÃ¤Ã¤n", day_tab: "PÃ¤ivÃ¤", week_tab: "Viikko", month_tab: "Kuukausi", new_event: "Uusi tapahtuma", icon_save: "Tallenna", icon_cancel: "Peru", icon_details: "Tiedot", icon_edit: "Muokkaa", icon_delete: "Poista", confirm_closing: "", confirm_deleting: "Haluatko varmasti poistaa tapahtuman?", section_description: "Kuvaus", section_time: "Aikajakso", full_day: "Koko pÃ¤ivÃ¤", confirm_recurring: "Haluatko varmasti muokata toistuvan tapahtuman kaikkia jaksoja?", section_recurring: "Toista tapahtuma", button_recurring: "Ei k&auml;yt&ouml;ss&auml;", button_recurring_open: "K&auml;yt&ouml;ss&auml;", button_edit_series: "Muokkaa sarja", button_edit_occurrence: "Muokkaa kopio", button_edit_occurrence_and_following: "This and following events", agenda_tab: "Esityslista", date: "PÃ¤ivÃ¤mÃ¤Ã¤rÃ¤", description: "Kuvaus", year_tab: "Vuoden", week_agenda_tab: "Esityslista", grid_tab: "RitilÃ¤", drag_to_create: "Luo uusi vetÃ¤mÃ¤llÃ¤", drag_to_move: "SiirrÃ¤ vetÃ¤mÃ¤llÃ¤", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "P&auml;ivitt&auml;in", repeat_radio_week: "Viikoittain", repeat_radio_month: "Kuukausittain", repeat_radio_year: "Vuosittain", repeat_radio_day_type: "Joka", repeat_text_day_count: "p&auml;iv&auml;", repeat_radio_day_type2: "Joka arkip&auml;iv&auml;", repeat_week: "Toista joka", repeat_text_week_count: "viikko n&auml;in&auml; p&auml;ivin&auml;:", repeat_radio_month_type: "Toista", repeat_radio_month_start: "", repeat_text_month_day: "p&auml;iv&auml;n&auml; joka", repeat_text_month_count: "kuukausi", repeat_text_month_count2_before: "joka", repeat_text_month_count2_after: "kuukausi", repeat_year_label: "", select_year_day2: "", repeat_text_year_day: "p&auml;iv&auml;", select_year_month: "kuukausi", repeat_radio_end: "Ei loppumisaikaa", repeat_text_occurrences_count: "Toiston j&auml;lkeen", repeat_radio_end3: "Loppuu", repeat_radio_end2: "", repeat_never: "Ei koskaan", repeat_daily: "Joka pÃ¤ivÃ¤", repeat_workdays: "Joka arkipÃ¤ivÃ¤", repeat_weekly: "Joka viikko", repeat_monthly: "Joka kuukausi", repeat_yearly: "Joka vuosi", repeat_custom: "Mukautettu", repeat_freq_day: "PÃ¤ivÃ¤", repeat_freq_week: "Viikko", repeat_freq_month: "Kuukausi", repeat_freq_year: "Vuosi", repeat_on_date: "TiettynÃ¤ pÃ¤ivÃ¤nÃ¤", repeat_ends: "PÃ¤Ã¤ttyy", month_for_recurring: ["Tammikuu", "Helmikuu", "Maaliskuu", "Huhtikuu", "Toukokuu", "Kes&auml;kuu", "Hein&auml;kuu", "Elokuu", "Syyskuu", "Lokakuu", "Marraskuu", "Joulukuu"], day_for_recurring: ["Sunnuntai", "Maanantai", "Tiistai", "Keskiviikko", "Torstai", "Perjantai", "Lauantai"] } };
  const fr = { date: { month_full: ["Janvier", "FÃ©vrier", "Mars", "Avril", "Mai", "Juin", "Juillet", "AoÃ»t", "Septembre", "Octobre", "Novembre", "DÃ©cembre"], month_short: ["Jan", "FÃ©v", "Mar", "Avr", "Mai", "Juin", "Juil", "AoÃ»", "Sep", "Oct", "Nov", "DÃ©c"], day_full: ["Dimanche", "Lundi", "Mardi", "Mercredi", "Jeudi", "Vendredi", "Samedi"], day_short: ["Dim", "Lun", "Mar", "Mer", "Jeu", "Ven", "Sam"] }, labels: { dhx_cal_today_button: "Aujourd'hui", day_tab: "Jour", week_tab: "Semaine", month_tab: "Mois", new_event: "Nouvel Ã©vÃ©nement", icon_save: "Enregistrer", icon_cancel: "Annuler", icon_details: "DÃ©tails", icon_edit: "Modifier", icon_delete: "Effacer", confirm_closing: "", confirm_deleting: "L'Ã©vÃ©nement sera effacÃ© sans appel, Ãªtes-vous sÃ»r ?", section_description: "Description", section_time: "PÃ©riode", full_day: "JournÃ©e complÃ¨te", confirm_recurring: "Voulez-vous Ã©diter toute une sÃ©rie d'Ã©vÃ¨nements rÃ©pÃ©tÃ©s?", section_recurring: "PÃ©riodicitÃ©", button_recurring: "DÃ©sactivÃ©", button_recurring_open: "ActivÃ©", button_edit_series: "Modifier la sÃ©rie", button_edit_occurrence: "Modifier une copie", button_edit_occurrence_and_following: "This and following events", agenda_tab: "Jour", date: "Date", description: "Description", year_tab: "AnnÃ©e", week_agenda_tab: "Jour", grid_tab: "Grille", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "Quotidienne", repeat_radio_week: "Hebdomadaire", repeat_radio_month: "Mensuelle", repeat_radio_year: "Annuelle", repeat_radio_day_type: "Chaque", repeat_text_day_count: "jour", repeat_radio_day_type2: "Chaque journÃ©e de travail", repeat_week: " RÃ©pÃ©ter toutes les", repeat_text_week_count: "semaine:", repeat_radio_month_type: "RÃ©pÃ©ter", repeat_radio_month_start: "Le", repeat_text_month_day: "jour chaque", repeat_text_month_count: "mois", repeat_text_month_count2_before: "chaque", repeat_text_month_count2_after: "mois", repeat_year_label: "Le", select_year_day2: "du", repeat_text_year_day: "jour", select_year_month: "mois", repeat_radio_end: "Pas de date d&quot;achÃ¨vement", repeat_text_occurrences_count: "occurrences", repeat_radio_end3: "Fin", repeat_radio_end2: "AprÃ¨s", repeat_never: "Jamais", repeat_daily: "Chaque jour", repeat_workdays: "Chaque jour ouvrable", repeat_weekly: "Chaque semaine", repeat_monthly: "Chaque mois", repeat_yearly: "Chaque annÃ©e", repeat_custom: "PersonnalisÃ©", repeat_freq_day: "Jour", repeat_freq_week: "Semaine", repeat_freq_month: "Mois", repeat_freq_year: "AnnÃ©e", repeat_on_date: "Ã€ la date", repeat_ends: "Se termine", month_for_recurring: ["Janvier", "FÃ©vrier", "Mars", "Avril", "Mai", "Juin", "Juillet", "AoÃ»t", "Septembre", "Octobre", "Novembre", "DÃ©cembre"], day_for_recurring: ["Dimanche", "Lundi", "Mardi", "Mercredi", "Jeudi", "Vendredi", "Samedi"] } };
  const he = { date: { month_full: ["×™× ×•××¨", "×¤×‘×¨×•××¨", "×ž×¨×¥", "××¤×¨×™×œ", "×ž××™", "×™×•× ×™", "×™×•×œ×™", "××•×’×•×¡×˜", "×¡×¤×˜×ž×‘×¨", "××•×§×˜×•×‘×¨", "× ×•×‘×ž×‘×¨", "×“×¦×ž×‘×¨"], month_short: ["×™× ×•", "×¤×‘×¨", "×ž×¨×¥", "××¤×¨", "×ž××™", "×™×•× ", "×™×•×œ", "××•×’", "×¡×¤×˜", "××•×§", "× ×•×‘", "×“×¦×ž"], day_full: ["×¨××©×•×Ÿ", "×©× ×™", "×©×œ×™×©×™", "×¨×‘×™×¢×™", "×—×ž×™×©×™", "×©×™×©×™", "×©×‘×ª"], day_short: ["×", "×‘", "×’", "×“", "×”", "×•", "×©"] }, labels: { dhx_cal_today_button: "×”×™×•×", day_tab: "×™×•×", week_tab: "×©×‘×•×¢", month_tab: "×—×•×“×©", new_event: "××¨×•×¢ ×—×“×©", icon_save: "×©×ž×•×¨", icon_cancel: "×‘×˜×œ", icon_details: "×¤×¨×˜×™×", icon_edit: "×¢×¨×•×š", icon_delete: "×ž×—×§", confirm_closing: "", confirm_deleting: "××¨×•×¢ ×™×ž×—×§ ×¡×•×¤×™×ª.×œ×”×ž×©×™×š?", section_description: "×ª×™××•×¨", section_time: "×ª×§×•×¤×”", confirm_recurring: "×”×× ×‘×¨×¦×•× ×š ×œ×©× ×•×ª ×›×œ ×¡×“×¨×ª ××¨×•×¢×™× ×ž×ª×ž×©×›×™×?", section_recurring: "×œ×”×¢×ª×™×§ ××¨×•×¢", button_recurring: "×œ× ×¤×¢×™×œ", button_recurring_open: "×¤×¢×™×œ", full_day: "×™×•× ×©×œ×", button_edit_series: "×¢×¨×•×š ××ª ×”×¡×“×¨×”", button_edit_occurrence: "×¢×¨×™×›×ª ×¢×•×ª×§", button_edit_occurrence_and_following: "This and following events", agenda_tab: "×¡×“×¨ ×™×•×", date: "×ª××¨×™×š", description: "×ª×™××•×¨", year_tab: "×œ×©× ×”", week_agenda_tab: "×¡×“×¨ ×™×•×", grid_tab: "×¡×•×¨×’", drag_to_create: "Drag to create", drag_to_move: "×’×¨×•×¨ ×›×“×™ ×œ×”×–×™×–", message_ok: "OK", message_cancel: "×‘×˜×œ", next: "×”×‘×", prev: "×”×§×•×“×", year: "×©× ×”", month: "×—×•×“×©", day: "×™×•×", hour: "×©×¢×”", minute: "×“×§×”", repeat_radio_day: "×™×•×ž×™", repeat_radio_week: "×©×‘×•×¢×™", repeat_radio_month: "×—×•×“×©×™", repeat_radio_year: "×©× ×ª×™", repeat_radio_day_type: "×—×–×•×¨ ×›×œ", repeat_text_day_count: "×™×ž×™×", repeat_radio_day_type2: "×—×–×•×¨ ×›×œ ×™×•× ×¢×‘×•×“×”", repeat_week: " ×—×–×•×¨ ×›×œ", repeat_text_week_count: "×©×‘×•×¢ ×œ×¤×™ ×™×ž×™×:", repeat_radio_month_type: "×—×–×•×¨ ×›×œ", repeat_radio_month_start: "×›×œ", repeat_text_month_day: "×™×ž×™× ×›×œ", repeat_text_month_count: "×—×•×“×©×™×", repeat_text_month_count2_before: "×—×–×•×¨ ×›×œ", repeat_text_month_count2_after: "×—×•×“×©", repeat_year_label: "×›×œ", select_year_day2: "×‘×—×•×“×©", repeat_text_year_day: "×™×ž×™×", select_year_month: "×—×•×“×©", repeat_radio_end: "×œ×¢×•×œ× ×œ× ×ž×¡×ª×™×™×", repeat_text_occurrences_count: "××™×¨×•×¢×™×", repeat_radio_end3: "×ž×¡×ª×™×™× ×‘", repeat_radio_end2: "××—×¨×™", repeat_never: "××£ ×¤×¢×", repeat_daily: "×›×œ ×™×•×", repeat_workdays: "×›×œ ×™×•× ×¢×‘×•×“×”", repeat_weekly: "×›×œ ×©×‘×•×¢", repeat_monthly: "×›×œ ×—×•×“×©", repeat_yearly: "×›×œ ×©× ×”", repeat_custom: "×ž×•×ª×× ××™×©×™×ª", repeat_freq_day: "×™×•×", repeat_freq_week: "×©×‘×•×¢", repeat_freq_month: "×—×•×“×©", repeat_freq_year: "×©× ×”", repeat_on_date: "×‘×ª××¨×™×š", repeat_ends: "×ž×¡×ª×™×™×", month_for_recurring: ["×™× ×•××¨", "×¤×‘×¨×•××¨", "×ž×¨×¥", "××¤×¨×™×œ", "×ž××™", "×™×•× ×™", "×™×•×œ×™", "××•×’×•×¡×˜", "×¡×¤×˜×ž×‘×¨", "××•×§×˜×•×‘×¨", "× ×•×‘×ž×‘×¨", "×“×¦×ž×‘×¨"], day_for_recurring: ["×¨××©×•×Ÿ", "×©× ×™", "×©×œ×™×©×™", "×¨×‘×™×¢×™", "×—×ž×™×©×™", "×©×™×©×™", "×©×‘×ª"] } };
  const hu = { date: { month_full: ["JanuÃ¡r", "FebruÃ¡r", "MÃ¡rcius", "Ãprilis", "MÃ¡jus", "JÃºnius", "JÃºlius", "Augusztus", "Szeptember", "OktÃ³ber", "November", "December"], month_short: ["Jan", "Feb", "MÃ¡r", "Ãpr", "MÃ¡j", "JÃºn", "JÃºl", "Aug", "Sep", "Okt", "Nov", "Dec"], day_full: ["VasÃ¡rnap", "HÃ©tfÃµ", "Kedd", "Szerda", "CsÃ¼tÃ¶rtÃ¶k", "PÃ©ntek", "szombat"], day_short: ["Va", "HÃ©", "Ke", "Sze", "CsÃ¼", "PÃ©", "Szo"] }, labels: { dhx_cal_today_button: "Ma", day_tab: "Nap", week_tab: "HÃ©t", month_tab: "HÃ³nap", new_event: "Ãšj esemÃ©ny", icon_save: "MentÃ©s", icon_cancel: "MÃ©gse", icon_details: "RÃ©szletek", icon_edit: "SzerkesztÃ©s", icon_delete: "TÃ¶rlÃ©s", confirm_closing: "", confirm_deleting: "Az esemÃ©ny tÃ¶rÃ¶lve lesz, biztosan folytatja?", section_description: "LeÃ­rÃ¡s", section_time: "IdÃµszak", full_day: "Egesz napos", confirm_recurring: "Biztosan szerkeszteni akarod az Ã¶sszes ismÃ©tlÃµdÃµ esemÃ©ny beÃ¡llÃ­tÃ¡sÃ¡t?", section_recurring: "EsemÃ©ny ismÃ©tlÃ©se", button_recurring: "TiltÃ¡s", button_recurring_open: "EngedÃ©lyezÃ©s", button_edit_series: "Edit series", button_edit_occurrence: "SzerkesztÃ©s bÃ­rÃ³sÃ¡g", button_edit_occurrence_and_following: "This and following events", agenda_tab: "Napirend", date: "DÃ¡tum", description: "LeÃ­rÃ¡s", year_tab: "Ã‰v", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "Napi", repeat_radio_week: "Heti", repeat_radio_month: "Havi", repeat_radio_year: "Ã‰ves", repeat_radio_day_type: "Minden", repeat_text_day_count: "nap", repeat_radio_day_type2: "Minden munkanap", repeat_week: " IsmÃ©telje meg minden", repeat_text_week_count: "hÃ©ten a kÃ¶vetkezÅ‘ napokon:", repeat_radio_month_type: "IsmÃ©tlÃ©s", repeat_radio_month_start: "Ekkor", repeat_text_month_day: "nap minden", repeat_text_month_count: "hÃ³napban", repeat_text_month_count2_before: "minden", repeat_text_month_count2_after: "hÃ³napban", repeat_year_label: "Ekkor", select_year_day2: "-Ã¡n/-Ã©n", repeat_text_year_day: "nap", select_year_month: "hÃ³nap", repeat_radio_end: "Nincs befejezÃ©si dÃ¡tum", repeat_text_occurrences_count: "esemÃ©ny", repeat_radio_end2: "UtÃ¡n", repeat_radio_end3: "BefejezÅ‘ dÃ¡tum", repeat_never: "Soha", repeat_daily: "Minden nap", repeat_workdays: "Minden munkanap", repeat_weekly: "Minden hÃ©ten", repeat_monthly: "Minden hÃ³napban", repeat_yearly: "Minden Ã©vben", repeat_custom: "Egyedi", repeat_freq_day: "Nap", repeat_freq_week: "HÃ©t", repeat_freq_month: "HÃ³nap", repeat_freq_year: "Ã‰v", repeat_on_date: "DÃ¡tum szerint", repeat_ends: "BefejezÅ‘dik", month_for_recurring: ["JanuÃ¡r", "FebruÃ¡r", "MÃ¡rcius", "Ãprilis", "MÃ¡jus", "JÃºnius", "JÃºlius", "Augusztus", "Szeptember", "OktÃ³ber", "November", "December"], day_for_recurring: ["VasÃ¡rnap", "HÃ©tfÅ‘", "Kedd", "Szerda", "CsÃ¼tÃ¶rtÃ¶k", "PÃ©ntek", "Szombat"] } };
  ...
  const it = { date: { month_full: ["Gennaio", "Febbraio", "Marzo", "Aprile", "Maggio", "Giugno", "Luglio", "Agosto", "Settembre", "Ottobre", "Novembre", "Dicembre"], month_short: ["Gen", "Feb", "Mar", "Apr", "Mag", "Giu", "Lug", "Ago", "Set", "Ott", "Nov", "Dic"], day_full: ["Domenica", "LunedÃ¬", "MartedÃ¬", "MercoledÃ¬", "GiovedÃ¬", "VenerdÃ¬", "Sabato"], day_short: ["Dom", "Lun", "Mar", "Mer", "Gio", "Ven", "Sab"] }, labels: { dhx_cal_today_button: "Oggi", day_tab: "Giorno", week_tab: "Settimana", month_tab: "Mese", new_event: "Nuovo evento", icon_save: "Salva", icon_cancel: "Chiudi", icon_details: "Dettagli", icon_edit: "Modifica", icon_delete: "Elimina", confirm_closing: "", confirm_deleting: "L'evento sarÃ  eliminato, siete sicuri?", section_description: "Descrizione", section_time: "Periodo di tempo", full_day: "Intera giornata", confirm_recurring: "Vuoi modificare l'intera serie di eventi?", section_recurring: "Ripetere l'evento", button_recurring: "Disattivato", button_recurring_open: "Attivato", button_edit_series: "Modificare la serie", button_edit_occurrence: "Modificare una copia", button_edit_occurrence_and_following: "This and following events", agenda_tab: "Agenda", date: "Data", description: "Descrizione", year_tab: "Anno", week_agenda_tab: "Agenda", grid_tab: "Griglia", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "Quotidiano", repeat_radio_week: "Settimanale", repeat_radio_month: "Mensile", repeat_radio_year: "Annuale", repeat_radio_day_type: "Ogni", repeat_text_day_count: "giorno", repeat_radio_day_type2: "Ogni giornata lavorativa", repeat_week: " Ripetere ogni", repeat_text_week_count: "settimana:", repeat_radio_month_type: "Ripetere", repeat_radio_month_start: "Il", repeat_text_month_day: "giorno ogni", repeat_text_month_count: "mese", repeat_text_month_count2_before: "ogni", repeat_text_month_count2_after: "mese", repeat_year_label: "Il", select_year_day2: "del", repeat_text_year_day: "giorno", select_year_month: "mese", repeat_radio_end: "Senza data finale", repeat_text_occurrences_count: "occorenze", repeat_radio_end3: "Fine", repeat_radio_end2: "Dopo", repeat_never: "Mai", repeat_daily: "Ogni giorno", repeat_workdays: "Ogni giorno feriale", repeat_weekly: "Ogni settimana", repeat_monthly: "Ogni mese", repeat_yearly: "Ogni anno", repeat_custom: "Personalizzato", repeat_freq_day: "Giorno", repeat_freq_week: "Settimana", repeat_freq_month: "Mese", repeat_freq_year: "Anno", repeat_on_date: "Alla data", repeat_ends: "Finisce", month_for_recurring: ["Gennaio", "Febbraio", "Marzo", "Aprile", "Maggio", "Jiugno", "Luglio", "Agosto", "Settembre", "Ottobre", "Novembre", "Dicembre"], day_for_recurring: ["Domenica", "LunedÃ¬", "MartedÃ¬", "MercoledÃ¬", "JovedÃ¬", "VenerdÃ¬", "Sabato"] } };
  const jp = { date: { month_full: ["1æœˆ", "2æœˆ", "3æœˆ", "4æœˆ", "5æœˆ", "6æœˆ", "7æœˆ", "8æœˆ", "9æœˆ", "10æœˆ", "11æœˆ", "12æœˆ"], month_short: ["1æœˆ", "2æœˆ", "3æœˆ", "4æœˆ", "5æœˆ", "6æœˆ", "7æœˆ", "8æœˆ", "9æœˆ", "10æœˆ", "11æœˆ", "12æœˆ"], day_full: ["æ—¥æ›œæ—¥", "æœˆæ›œæ—¥", "ç«æ›œæ—¥", "æ°´æ›œæ—¥", "æœ¨æ›œæ—¥", "é‡‘æ›œæ—¥", "åœŸæ›œæ—¥"], day_short: ["æ—¥", "æœˆ", "ç«", "æ°´", "æœ¨", "é‡‘", "åœŸ"] }, labels: { dhx_cal_today_button: "ä»Šæ—¥", day_tab: "æ—¥", week_tab: "é€±", month_tab: "æœˆ", new_event: "æ–°ã‚¤ãƒ™ãƒ³ãƒˆ", icon_save: "ä¿å­˜", icon_cancel: "ã‚­ãƒ£ãƒ³ã‚»ãƒ«", icon_details: "è©³ç´°", icon_edit: "ç·¨é›†", icon_delete: "å‰Šé™¤", confirm_closing: "", confirm_deleting: "ã‚¤ãƒ™ãƒ³ãƒˆå®Œå…¨ã«å‰Šé™¤ã•ã‚Œã¾ã™ã€å®œã—ã„ã§ã™ã‹ï¼Ÿ", section_description: "ãƒ‡ã‚¹ã‚¯ãƒªãƒ—ã‚·ãƒ§ãƒ³", section_time: "æœŸé–“", confirm_recurring: "ç¹°ã‚Šè¿”ã•ã‚Œã¦ã„ã‚‹ã‚¤ãƒ™ãƒ³ãƒˆã‚’å…¨ã¦ç·¨é›†ã—ã¾ã™ã‹ï¼Ÿ", section_recurring: "ã‚¤ãƒ™ãƒ³ãƒˆã‚’ç¹°ã‚Šè¿”ã™", button_recurring: "ç„¡åŠ¹", button_recurring_open: "æœ‰åŠ¹", full_day: "çµ‚æ—¥", button_edit_series: "ã‚·ãƒªãƒ¼ã‚ºã‚’ç·¨é›†ã—ã¾ã™", button_edit_occurrence: "ã‚³ãƒ”ãƒ¼ã‚’ç·¨é›†", button_edit_occurrence_and_following: "This and following events", agenda_tab: "è­°é¡Œã¯", date: "æ—¥ä»˜", description: "èª¬æ˜Ž", year_tab: "ä»Šå¹´", week_agenda_tab: "è­°é¡Œã¯", grid_tab: "ã‚°ãƒªãƒƒãƒ‰", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "æ¯Žæ—¥", repeat_radio_week: "æ¯Žé€±", repeat_radio_month: "æ¯Žæœˆ", repeat_radio_year: "æ¯Žå¹´", repeat_radio_day_type: "æ¯Ž", repeat_text_day_count: "æ—¥", repeat_radio_day_type2: "æ¯Žå–¶æ¥­æ—¥", repeat_week: " ç¹°ã‚Šè¿”ã—æ¯Ž", repeat_text_week_count: "é€± æ¬¡ã®æ—¥:", repeat_radio_month_type: "ç¹°ã‚Šè¿”ã—", repeat_radio_month_start: "ã‚ªãƒ³", repeat_text_month_day: "æ—¥æ¯Ž", repeat_text_month_count: "æœˆ", repeat_text_month_count2_before: "æ¯Ž", repeat_text_month_count2_after: "æœˆ", repeat_year_label: "ã‚ªãƒ³", select_year_day2: "ã®", repeat_text_year_day: "æ—¥", select_year_month: "æœˆ", repeat_radio_end: "çµ‚äº†æ—¥ãªã—", repeat_text_occurrences_count: "å›žæ•°", repeat_radio_end2: "å¾Œ", repeat_radio_end3: "çµ‚äº†æ—¥ã¾ã§", repeat_never: "æ±ºã—ã¦", repeat_daily: "æ¯Žæ—¥", repeat_workdays: "æ¯Žå–¶æ¥­æ—¥", repeat_weekly: "æ¯Žé€±", repeat_monthly: "æ¯Žæœˆ", repeat_yearly: "æ¯Žå¹´", repeat_custom: "ã‚«ã‚¹ã‚¿ãƒ ", repeat_freq_day: "æ—¥", repeat_freq_week: "é€±", repeat_freq_month: "æœˆ", repeat_freq_year: "å¹´", repeat_on_date: "æ—¥ã«ã¡", repeat_ends: "çµ‚äº†", month_for_recurring: ["1æœˆ", "2æœˆ", "3æœˆ", "4æœˆ", "5æœˆ", "6æœˆ", "7æœˆ", "8æœˆ", "9æœˆ", "10æœˆ", "11æœˆ", "12æœˆ"], day_for_recurring: ["æ—¥æ›œæ—¥", "æœˆæ›œæ—¥", "ç«æ›œæ—¥", "æ°´æ›œæ—¥", "æœ¨æ›œæ—¥", "é‡‘æ›œæ—¥", "åœŸæ›œæ—¥"] } };
  class LocaleManager {
    constructor(config) {
      this._locales = {};
  ...
  const nb = { date: { month_full: ["Januar", "Februar", "Mars", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Desember"], month_short: ["Jan", "Feb", "Mar", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Des"], day_full: ["SÃ¸ndag", "Mandag", "Tirsdag", "Onsdag", "Torsdag", "Fredag", "LÃ¸rdag"], day_short: ["SÃ¸n", "Mon", "Tir", "Ons", "Tor", "Fre", "LÃ¸r"] }, labels: { dhx_cal_today_button: "I dag", day_tab: "Dag", week_tab: "Uke", month_tab: "MÃ¥ned", new_event: "Ny hendelse", icon_save: "Lagre", icon_cancel: "Avbryt", icon_details: "Detaljer", icon_edit: "Rediger", icon_delete: "Slett", confirm_closing: "", confirm_deleting: "Hendelsen vil bli slettet permanent. Er du sikker?", section_description: "Beskrivelse", section_time: "Tidsperiode", confirm_recurring: "Vil du forandre hele dette settet av repeterende hendelser?", section_recurring: "Repeter hendelsen", button_recurring: "Av", button_recurring_open: "PÃ¥", button_edit_series: "Rediger serien", button_edit_occurrence: "Redigere en kopi", button_edit_occurrence_and_following: "This and following events", agenda_tab: "Agenda", date: "Dato", description: "Beskrivelse", year_tab: "Ã…r", week_agenda_tab: "Agenda", grid_tab: "Grid", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "Daglig", repeat_radio_week: "Ukentlig", repeat_radio_month: "MÃ¥nedlig", repeat_radio_year: "Ã…rlig", repeat_radio_day_type: "Hver", repeat_text_day_count: "dag", repeat_radio_day_type2: "Alle hverdager", repeat_week: " Gjentas hver", repeat_text_week_count: "uke pÃ¥:", repeat_radio_month_type: "PÃ¥ hver", repeat_radio_month_start: "PÃ¥", repeat_text_month_day: "dag hver", repeat_text_month_count: "mÃ¥ned", repeat_text_month_count2_before: "hver", repeat_text_month_count2_after: "mÃ¥ned", repeat_year_label: "pÃ¥", select_year_day2: "i", repeat_text_year_day: "dag i", select_year_month: "", repeat_radio_end: "Ingen sluttdato", repeat_text_occurrences_count: "forekomst", repeat_radio_end3: "Stop den", repeat_radio_end2: "Etter", repeat_never: "Aldri", repeat_daily: "Hver dag", repeat_workdays: "Hver ukedag", repeat_weekly: "Hver uke", repeat_monthly: "Hver mÃ¥ned", repeat_yearly: "Hvert Ã¥r", repeat_custom: "Tilpasset", repeat_freq_day: "Dag", repeat_freq_week: "Uke", repeat_freq_month: "MÃ¥ned", repeat_freq_year: "Ã…r", repeat_on_date: "PÃ¥ dato", repeat_ends: "Slutter", month_for_recurring: ["Januar", "Februar", "Mars", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Desember"], day_for_recurring: ["Sondag", "Mandag", "Tirsdag", "Onsdag", "Torsdag", "Fredag", "LÃ¸rdag"] } };
  ...
  const no = { date: { month_full: ["Januar", "Februar", "Mars", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Desember"], month_short: ["Jan", "Feb", "Mar", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Des"], day_full: ["SÃ¸ndag", "Mandag", "Tirsdag", "Onsdag", "Torsdag", "Fredag", "LÃ¸rdag"], day_short: ["SÃ¸n", "Man", "Tir", "Ons", "Tor", "Fre", "LÃ¸r"] }, labels: { dhx_cal_today_button: "Idag", day_tab: "Dag", week_tab: "Uke", month_tab: "MÃ¥ned", new_event: "Ny", icon_save: "Lagre", icon_cancel: "Avbryt", icon_details: "Detaljer", icon_edit: "Endre", icon_delete: "Slett", confirm_closing: "Endringer blir ikke lagret, er du sikker?", confirm_deleting: "OppfÃ¸ringen vil bli slettet, er du sikker?", section_description: "Beskrivelse", section_time: "Tidsperiode", full_day: "Full dag", confirm_recurring: "Vil du endre hele settet med repeterende oppfÃ¸ringer?", section_recurring: "Repeterende oppfÃ¸ring", button_recurring: "Ikke aktiv", button_recurring_open: "Aktiv", button_edit_series: "Rediger serien", button_edit_occurrence: "Redigere en kopi", button_edit_occurrence_and_following: "This and following events", agenda_tab: "Agenda", date: "Dato", description: "Beskrivelse", year_tab: "Ã…r", week_agenda_tab: "Agenda", grid_tab: "Grid", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "Daglig", repeat_radio_week: "Ukentlig", repeat_radio_month: "MÃ¥nedlig", repeat_radio_year: "Ã…rlig", repeat_radio_day_type: "Hver", repeat_text_day_count: "dag", repeat_radio_day_type2: "Hver arbeidsdag", repeat_week: " Gjenta hver", repeat_text_week_count: "uke neste dager:", repeat_radio_month_type: "Gjenta", repeat_radio_month_start: "PÃ¥", repeat_text_month_day: "dag hver", repeat_text_month_count: "mÃ¥ned", repeat_text_month_count2_before: "hver", repeat_text_month_count2_after: "mÃ¥ned", repeat_year_label: "PÃ¥", select_year_day2: "av", repeat_text_year_day: "dag", select_year_month: "mÃ¥ned", repeat_radio_end: "Ingen sluttdato", repeat_text_occurrences_count: "forekomster", repeat_radio_end2: "Etter", repeat_radio_end3: "Slutt innen", repeat_never: "Aldri", repeat_daily: "Hver dag", repeat_workdays: "Hver ukedag", repeat_weekly: "Hver uke", repeat_monthly: "Hver mÃ¥ned", repeat_yearly: "Hvert Ã¥r", repeat_custom: "Tilpasset", repeat_freq_day: "Dag", repeat_freq_week: "Uke", repeat_freq_month: "MÃ¥ned", repeat_freq_year: "Ã…r", repeat_on_date: "PÃ¥ dato", repeat_ends: "Slutter", month_for_recurring: ["Januar", "Februar", "Mars", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Desember"], day_for_recurring: ["SÃ¸ndag", "Mandag", "Tirsdag", "Onsdag", "Torsdag", "Fredag", "LÃ¸rdag"] } };
  const pl = { date: { month_full: ["StyczeÅ„", "Luty", "Marzec", "KwiecieÅ„", "Maj", "Czerwiec", "Lipiec", "SierpieÅ„", "WrzesieÅ„", "PaÅºdziernik", "Listopad", "GrudzieÅ„"], month_short: ["Sty", "Lut", "Mar", "Kwi", "Maj", "Cze", "Lip", "Sie", "Wrz", "PaÅº", "Lis", "Gru"], day_full: ["Niedziela", "PoniedziaÅ‚ek", "Wtorek", "Åšroda", "Czwartek", "PiÄ…tek", "Sobota"], day_short: ["Nie", "Pon", "Wto", "Åšro", "Czw", "PiÄ…", "Sob"] }, labels: { dhx_cal_today_button: "DziÅ›", day_tab: "DzieÅ„", week_tab: "TydzieÅ„", month_tab: "MiesiÄ…c", new_event: "Nowe zdarzenie", icon_save: "Zapisz", icon_cancel: "Anuluj", icon_details: "SzczegÃ³Å‚y", icon_edit: "Edytuj", icon_delete: "UsuÅ„", confirm_closing: "", confirm_deleting: "Zdarzenie zostanie usuniÄ™te na zawsze, kontynuowaÄ‡?", section_description: "Opis", section_time: "Okres czasu", full_day: "CaÅ‚y dzieÅ„", confirm_recurring: "Czy chcesz edytowaÄ‡ caÅ‚y zbiÃ³r powtarzajÄ…cych siÄ™ zdarzeÅ„?", section_recurring: "PowtÃ³rz zdarzenie", button_recurring: "Nieaktywne", button_recurring_open: "Aktywne", button_edit_series: "Edytuj seriÄ™", button_edit_occurrence: "Edytuj kopiÄ™", button_edit_occurrence_and_following: "This and following events", agenda_tab: "Agenda", date: "Data", description: "Opis", year_tab: "Rok", week_agenda_tab: "Agenda", grid_tab: "Tabela", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "Codziennie", repeat_radio_week: "Co tydzie", repeat_radio_month: "Co miesic", repeat_radio_year: "Co rok", repeat_radio_day_type: "Kadego", repeat_text_day_count: "dnia", repeat_radio_day_type2: "Kadego dnia roboczego", repeat_week: " Powtarzaj kadego", repeat_text_week_count: "tygodnia w dni:", repeat_radio_month_type: "Powtrz", repeat_radio_month_start: "W", repeat_text_month_day: "dnia kadego", repeat_text_month_count: "miesica", repeat_text_month_count2_before: "kadego", repeat_text_month_count2_after: "miesica", repeat_year_label: "W", select_year_day2: "miesica", repeat_text_year_day: "dnia miesica", select_year_month: "", repeat_radio_end: "Bez daty kocowej", repeat_text_occurrences_count: "wystpieniu/ach", repeat_radio_end3: "Zakocz w", repeat_radio_end2: "Po", repeat_never: "Nigdy", repeat_daily: "Codziennie", repeat_workdays: "KaÅ¼dy dzieÅ„ roboczy", repeat_weekly: "Co tydzieÅ„", repeat_monthly: "Co miesiÄ…c", repeat_yearly: "Co rok", repeat_custom: "Niestandardowy", repeat_freq_day: "DzieÅ„", repeat_freq_week: "TydzieÅ„", repeat_freq_month: "MiesiÄ…c", repeat_freq_year: "Rok", repeat_on_date: "W dniu", repeat_ends: "KoÅ„czy siÄ™", month_for_recurring: ["Stycznia", "Lutego", "Marca", "Kwietnia", "Maja", "Czerwca", "Lipca", "Sierpnia", "Wrzenia", "Padziernka", "Listopada", "Grudnia"], day_for_recurring: ["Niedziela", "Poniedziaek", "Wtorek", "roda", "Czwartek", "Pitek", "Sobota"] } };
  const pt = { date: { month_full: ["Janeiro", "Fevereiro", "MarÃ§o", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"], month_short: ["Jan", "Fev", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dez"], day_full: ["Domingo", "Segunda", "TerÃ§a", "Quarta", "Quinta", "Sexta", "SÃ¡bado"], day_short: ["Dom", "Seg", "Ter", "Qua", "Qui", "Sex", "Sab"] }, labels: { dhx_cal_today_button: "Hoje", day_tab: "Dia", week_tab: "Semana", month_tab: "MÃªs", new_event: "Novo evento", icon_save: "Salvar", icon_cancel: "Cancelar", icon_details: "Detalhes", icon_edit: "Editar", icon_delete: "Deletar", confirm_closing: "", confirm_deleting: "Tem certeza que deseja excluir?", section_description: "DescriÃ§Ã£o", section_time: "PerÃ­odo de tempo", full_day: "Dia inteiro", confirm_recurring: "Deseja editar todos esses eventos repetidos?", section_recurring: "Repetir evento", button_recurring: "Desabilitar", button_recurring_open: "Habilitar", button_edit_series: "Editar a sÃ©rie", button_edit_occurrence: "Editar uma cÃ³pia", button_edit_occurrence_and_following: "This and following events", agenda_tab: "Dia", date: "Data", description: "DescriÃ§Ã£o", year_tab: "Ano", week_agenda_tab: "Dia", grid_tab: "Grade", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "DiÃ¡rio", repeat_radio_week: "Semanal", repeat_radio_month: "Mensal", repeat_radio_year: "Anual", repeat_radio_day_type: "Cada", repeat_text_day_count: "dia(s)", repeat_radio_day_type2: "Cada trabalho diÃ¡rio", repeat_week: " Repita cada", repeat_text_week_count: "semana:", repeat_radio_month_type: "Repetir", repeat_radio_month_start: "Em", repeat_text_month_day: "todo dia", repeat_text_month_count: "mÃªs", repeat_text_month_count2_before: "todo", repeat_text_month_count2_after: "mÃªs", repeat_year_label: "Em", select_year_day2: "of", repeat_text_year_day: "dia", select_year_month: "mÃªs", repeat_radio_end: "Sem data final", repeat_text_occurrences_count: "ocorrÃªncias", repeat_radio_end3: "Fim", repeat_radio_end2: "Depois", repeat_never: "Nunca", repeat_daily: "Todos os dias", repeat_workdays: "Todos os dias Ãºteis", repeat_weekly: "Toda semana", repeat_monthly: "Todo mÃªs", repeat_yearly: "Todo ano", repeat_custom: "Personalizado", repeat_freq_day: "Dia", repeat_freq_week: "Semana", repeat_freq_month: "MÃªs", repeat_freq_year: "Ano", repeat_on_date: "Na data", repeat_ends: "Termina", month_for_recurring: ["Janeiro", "Fevereiro", "MarÃ§o", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"], day_for_recurring: ["Domingo", "Segunda", "TerÃ§a", "Quarta", "Quinta", "Sexta", "SÃ¡bado"] } };
  const ro = { date: { month_full: ["Ianuarie", "Februarie", "Martie", "Aprilie", "Mai", "Iunie", "Iulie", "August", "Septembrie", "Octombrie", "November", "December"], month_short: ["Ian", "Feb", "Mar", "Apr", "Mai", "Iun", "Iul", "Aug", "Sep", "Oct", "Nov", "Dec"], day_full: ["Duminica", "Luni", "Marti", "Miercuri", "Joi", "Vineri", "Sambata"], day_short: ["Du", "Lu", "Ma", "Mi", "Jo", "Vi", "Sa"] }, labels: { dhx_cal_today_button: "Astazi", day_tab: "Zi", week_tab: "Saptamana", month_tab: "Luna", new_event: "Eveniment nou", icon_save: "Salveaza", icon_cancel: "Anuleaza", icon_details: "Detalii", icon_edit: "Editeaza", icon_delete: "Sterge", confirm_closing: "Schimbarile nu vor fi salvate, esti sigur?", confirm_deleting: "Evenimentul va fi sters permanent, esti sigur?", section_description: "Descriere", section_time: "Interval", full_day: "Toata ziua", confirm_recurring: "Vrei sa editezi toata seria de evenimente repetate?", section_recurring: "Repetare", button_recurring: "Dezactivata", button_recurring_open: "Activata", button_edit_series: "Editeaza serie", button_edit_occurrence: "Editeaza doar intrare", button_edit_occurrence_and_following: "This and following events", agenda_tab: "Agenda", date: "Data", description: "Descriere", year_tab: "An", week_agenda_tab: "Agenda", grid_tab: "Lista", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "Zilnic", repeat_radio_week: "Saptamanal", repeat_radio_month: "Lunar", repeat_radio_year: "Anual", repeat_radio_day_type: "La fiecare", repeat_text_day_count: "zi(le)", repeat_radio_day_type2: "Fiecare zi lucratoare", repeat_week: " Repeta la fiecare", repeat_text_week_count: "saptamana in urmatoarele zile:", repeat_radio_month_type: "Repeta in", repeat_radio_month_start: "In a", repeat_text_month_day: "zi la fiecare", repeat_text_month_count: "luni", repeat_text_month_count2_before: "la fiecare", repeat_text_month_count2_after: "luni", repeat_year_label: "In", select_year_day2: "a lunii", repeat_text_year_day: "zi a lunii", select_year_month: "", repeat_radio_end: "Fara data de sfarsit", repeat_text_occurrences_count: "evenimente", repeat_radio_end3: "La data", repeat_radio_end2: "Dupa", repeat_never: "NiciodatÄƒ", repeat_daily: "ÃŽn fiecare zi", repeat_workdays: "ÃŽn fiecare zi lucrÄƒtoare", repeat_weekly: "ÃŽn fiecare sÄƒptÄƒmÃ¢nÄƒ", repeat_monthly: "ÃŽn fiecare lunÄƒ", repeat_yearly: "ÃŽn fiecare an", repeat_custom: "Personalizat", repeat_freq_day: "Zi", repeat_freq_week: "SÄƒptÄƒmÃ¢nÄƒ", repeat_freq_month: "LunÄƒ", repeat_freq_year: "An", repeat_on_date: "La data", repeat_ends: "Se terminÄƒ", month_for_recurring: ["Ianuarie", "Februarie", "Martie", "Aprilie", "Mai", "Iunie", "Iulie", "August", "Septembrie", "Octombrie", "Noiembrie", "Decembrie"], day_for_recurring: ["Duminica", "Luni", "Marti", "Miercuri", "Joi", "Vineri", "Sambata"] } };
  const ru = { date: { month_full: ["Ð¯Ð½Ð²Ð°Ñ€ÑŒ", "Ð¤ÐµÐ²Ñ€Ð°Ð»ÑŒ", "ÐœÐ°Ñ€Ñ‚", "ÐÐ¿Ñ€ÐµÐ»ÑŒ", "MaÐ¹", "Ð˜ÑŽÐ½ÑŒ", "Ð˜ÑŽÐ»ÑŒ", "ÐÐ²Ð³ÑƒÑÑ‚", "Ð¡ÐµÐ½Ñ‚ÑÐ±Ñ€ÑŒ", "OÐºÑ‚ÑÐ±Ñ€ÑŒ", "ÐÐ¾ÑÐ±Ñ€ÑŒ", "Ð”ÐµÐºÐ°Ð±Ñ€ÑŒ"], month_short: ["Ð¯Ð½Ð²", "Ð¤ÐµÐ²", "MaÑ€", "AÐ¿Ñ€", "MaÐ¹", "Ð˜ÑŽÐ½", "Ð˜ÑŽÐ»", "AÐ²Ð³", "Ð¡ÐµÐ½", "ÐžÐºÑ‚", "ÐÐ¾Ñ", "Ð”ÐµÐº"], day_full: ["Ð’Ð¾ÑÐºÑ€ÐµÑÐµÐ½ÑŒÐµ", "ÐŸÐ¾Ð½ÐµÐ´ÐµÐ»ÑŒÐ½Ð¸Ðº", "Ð’Ñ‚Ð¾Ñ€Ð½Ð¸Ðº", "Ð¡Ñ€ÐµÐ´Ð°", "Ð§ÐµÑ‚Ð²ÐµÑ€Ð³", "ÐŸÑÑ‚Ð½Ð¸Ñ†Ð°", "Ð¡ÑƒÐ±Ð±Ð¾Ñ‚Ð°"], day_short: ["Ð’Ñ", "ÐŸÐ½", "Ð’Ñ‚", "Ð¡Ñ€", "Ð§Ñ‚", "ÐŸÑ‚", "Ð¡Ð±"] }, labels: { dhx_cal_today_button: "Ð¡ÐµÐ³Ð¾Ð´Ð½Ñ", day_tab: "Ð”ÐµÐ½ÑŒ", week_tab: "ÐÐµÐ´ÐµÐ»Ñ", month_tab: "ÐœÐµÑÑÑ†", new_event: "ÐÐ¾Ð²Ð¾Ðµ ÑÐ¾Ð±Ñ‹Ñ‚Ð¸Ðµ", icon_save: "Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ", icon_cancel: "ÐžÑ‚Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ", icon_details: "Ð”ÐµÑ‚Ð°Ð»Ð¸", icon_edit: "Ð˜Ð·Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ", icon_delete: "Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ", confirm_closing: "", confirm_deleting: "Ð¡Ð¾Ð±Ñ‹Ñ‚Ð¸Ðµ Ð±ÑƒÐ´ÐµÑ‚ ÑƒÐ´Ð°Ð»ÐµÐ½Ð¾ Ð±ÐµÐ·Ð²Ð¾Ð·Ð²Ñ€Ð°Ñ‚Ð½Ð¾, Ð¿Ñ€Ð¾Ð´Ð¾Ð»Ð¶Ð¸Ñ‚ÑŒ?", section_description: "ÐžÐ¿Ð¸ÑÐ°Ð½Ð¸Ðµ", section_time: "ÐŸÐµÑ€Ð¸Ð¾Ð´ Ð²Ñ€ÐµÐ¼ÐµÐ½Ð¸", full_day: "Ð’ÐµÑÑŒ Ð´ÐµÐ½ÑŒ", confirm_recurring: "Ð’Ñ‹ Ñ…Ð¾Ñ‚Ð¸Ñ‚Ðµ Ð¸Ð·Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ Ð²ÑÑŽ ÑÐµÑ€Ð¸ÑŽ Ð¿Ð¾Ð²Ñ‚Ð¾Ñ€ÑÑŽÑ‰Ð¸Ñ…ÑÑ ÑÐ¾Ð±Ñ‹Ñ‚Ð¸Ð¹?", section_recurring: "ÐŸÐ¾Ð²Ñ‚Ð¾Ñ€ÐµÐ½Ð¸Ðµ", button_recurring: "ÐžÑ‚ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¾", button_recurring_open: "Ð’ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¾", button_edit_series: "Ð ÐµÐ´Ð°ÐºÑ‚Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ ÑÐµÑ€Ð¸ÑŽ", button_edit_occurrence: "Ð ÐµÐ´Ð°ÐºÑ‚Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ ÑÐºÐ·ÐµÐ¼Ð¿Ð»ÑÑ€", button_edit_occurrence_and_following: "This and following events", agenda_tab: "Ð¡Ð¿Ð¸ÑÐ¾Ðº", date: "Ð”Ð°Ñ‚Ð°", description: "ÐžÐ¿Ð¸ÑÐ°Ð½Ð¸Ðµ", year_tab: "Ð“Ð¾Ð´", week_agenda_tab: "Ð¡Ð¿Ð¸ÑÐ¾Ðº", grid_tab: "Ð¢Ð°Ð±Ð»Ð¸Ñ†Ð°", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "Ð”ÐµÐ½ÑŒ", repeat_radio_week: "ÐÐµÐ´ÐµÐ»Ñ", repeat_radio_month: "ÐœÐµÑÑÑ†", repeat_radio_year: "Ð“Ð¾Ð´", repeat_radio_day_type: "ÐšÐ°Ð¶Ð´Ñ‹Ð¹", repeat_text_day_count: "Ð´ÐµÐ½ÑŒ", repeat_radio_day_type2: "ÐšÐ°Ð¶Ð´Ñ‹Ð¹ Ñ€Ð°Ð±Ð¾Ñ‡Ð¸Ð¹ Ð´ÐµÐ½ÑŒ", repeat_week: " ÐŸÐ¾Ð²Ñ‚Ð¾Ñ€ÑÑ‚ÑŒ ÐºÐ°Ð¶Ð´ÑƒÑŽ", repeat_text_week_count: "Ð½ÐµÐ´ÐµÐ»ÑŽ , Ð²:", repeat_radio_month_type: "ÐŸÐ¾Ð²Ñ‚Ð¾Ñ€ÑÑ‚ÑŒ", repeat_radio_month_start: "", repeat_text_month_day: " Ñ‡Ð¸ÑÐ»Ð° ÐºÐ°Ð¶Ð´Ñ‹Ð¹ ", repeat_text_month_count: "Ð¼ÐµÑÑÑ†", repeat_text_month_count2_before: "ÐºÐ°Ð¶Ð´Ñ‹Ð¹ ", repeat_text_month_count2_after: "Ð¼ÐµÑÑÑ†", repeat_year_label: "", select_year_day2: "", repeat_text_year_day: "Ð´ÐµÐ½ÑŒ", select_year_month: "", repeat_radio_end: "Ð‘ÐµÐ· Ð´Ð°Ñ‚Ñ‹ Ð¾ÐºÐ¾Ð½Ñ‡Ð°Ð½Ð¸Ñ", repeat_text_occurrences_count: "Ð¿Ð¾Ð²Ñ‚Ð¾Ñ€ÐµÐ½Ð¸Ð¹", repeat_radio_end3: "Ð”Ð¾ ", repeat_radio_end2: "", repeat_never: "ÐÐ¸ÐºÐ¾Ð³Ð´Ð°", repeat_daily: "ÐšÐ°Ð¶Ð´Ñ‹Ð¹ Ð´ÐµÐ½ÑŒ", repeat_workdays: "ÐšÐ°Ð¶Ð´Ñ‹Ð¹ Ð±ÑƒÐ´Ð½Ð¸Ð¹ Ð´ÐµÐ½ÑŒ", repeat_weekly: "ÐšÐ°Ð¶Ð´ÑƒÑŽ Ð½ÐµÐ´ÐµÐ»ÑŽ", repeat_monthly: "ÐšÐ°Ð¶Ð´Ñ‹Ð¹ Ð¼ÐµÑÑÑ†", repeat_yearly: "ÐšÐ°Ð¶Ð´Ñ‹Ð¹ Ð³Ð¾Ð´", repeat_custom: "ÐÐ°ÑÑ‚Ñ€Ð¾Ð¸Ñ‚ÑŒ", repeat_freq_day: "Ð”ÐµÐ½ÑŒ", repeat_freq_week: "ÐÐµÐ´ÐµÐ»Ñ", repeat_freq_month: "ÐœÐµÑÑÑ†", repeat_freq_year: "Ð“Ð¾Ð´", repeat_on_date: "Ð’ Ð´Ð°Ñ‚Ñƒ", repeat_ends: "Ð—Ð°ÐºÐ°Ð½Ñ‡Ð¸Ð²Ð°ÐµÑ‚ÑÑ", month_for_recurring: ["Ð¯Ð½Ð²Ð°Ñ€Ñ", "Ð¤ÐµÐ²Ñ€Ð°Ð»Ñ", "ÐœÐ°Ñ€Ñ‚Ð°", "ÐÐ¿Ñ€ÐµÐ»Ñ", "ÐœÐ°Ñ", "Ð˜ÑŽÐ½Ñ", "Ð˜ÑŽÐ»Ñ", "ÐÐ²Ð³ÑƒÑÑ‚Ð°", "Ð¡ÐµÐ½Ñ‚ÑÐ±Ñ€Ñ", "ÐžÐºÑ‚ÑÐ±Ñ€Ñ", "ÐÐ¾ÑÐ±Ñ€Ñ", "Ð”ÐµÐºÐ°Ð±Ñ€Ñ"], day_for_recurring: ["Ð’Ð¾ÑÐºÑ€ÐµÑÐµÐ½ÑŒÐµ", "ÐŸÐ¾Ð½ÐµÐ´ÐµÐ»ÑŒÐ½Ð¸Ðº", "Ð’Ñ‚Ð¾Ñ€Ð½Ð¸Ðº", "Ð¡Ñ€ÐµÐ´Ñƒ", "Ð§ÐµÑ‚Ð²ÐµÑ€Ð³", "ÐŸÑÑ‚Ð½Ð¸Ñ†Ñƒ", "Ð¡ÑƒÐ±Ð±Ð¾Ñ‚Ñƒ"] } };
  const si = { date: { month_full: ["Januar", "Februar", "Marec", "April", "Maj", "Junij", "Julij", "Avgust", "September", "Oktober", "November", "December"], month_short: ["Jan", "Feb", "Mar", "Apr", "Maj", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dec"], day_full: ["Nedelja", "Ponedeljek", "Torek", "Sreda", "ÄŒetrtek", "Petek", "Sobota"], day_short: ["Ned", "Pon", "Tor", "Sre", "ÄŒet", "Pet", "Sob"] }, labels: { dhx_cal_today_button: "Danes", day_tab: "Dan", week_tab: "Teden", month_tab: "Mesec", new_event: "Nov dogodek", icon_save: "Shrani", icon_cancel: "PrekliÄi", icon_details: "Podrobnosti", icon_edit: "Uredi", icon_delete: "IzbriÅ¡i", confirm_closing: "", confirm_deleting: "Dogodek bo izbrisan. Å½elite nadaljevati?", section_description: "Opis", section_time: "ÄŒasovni okvir", full_day: "Ves dan", confirm_recurring: "Å½elite urediti celoten set ponavljajoÄih dogodkov?", section_recurring: "Ponovi dogodek", button_recurring: "OnemogoÄeno", button_recurring_open: "OmogoÄeno", button_edit_series: "Edit series", button_edit_occurrence: "Edit occurrence", button_edit_occurrence_and_following: "This and following events", agenda_tab: "Zadeva", date: "Datum", description: "Opis", year_tab: "Leto", week_agenda_tab: "Zadeva", grid_tab: "Miza", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "Dnevno", repeat_radio_week: "Tedensko", repeat_radio_month: "MeseÄno", repeat_radio_year: "Letno", repeat_radio_day_type: "Vsak", repeat_text_day_count: "dan", repeat_radio_day_type2: "Vsak delovni dan", repeat_week: " Ponavljaj vsak", repeat_text_week_count: "teden na naslednje dni:", repeat_radio_month_type: "Ponavljaj", repeat_radio_month_start: "Na", repeat_text_month_day: "dan vsak", repeat_text_month_count: "mesec", repeat_text_month_count2_before: "vsak", repeat_text_month_count2_after: "mesec", repeat_year_label: "Na", select_year_day2: "od", repeat_text_year_day: "dan", select_year_month: "mesec", repeat_radio_end: "Brez konÄnega datuma", repeat_text_occurrences_count: "pojavitve", repeat_radio_end2: "Po", repeat_radio_end3: "KonÄaj do", repeat_never: "Nikoli", repeat_daily: "Vsak dan", repeat_workdays: "Vsak delovni dan", repeat_weekly: "Vsak teden", repeat_monthly: "Vsak mesec", repeat_yearly: "Vsako leto", repeat_custom: "Po meri", repeat_freq_day: "Dan", repeat_freq_week: "Teden", repeat_freq_month: "Mesec", repeat_freq_year: "Leto", repeat_on_date: "Na datum", repeat_ends: "KonÄa se", month_for_recurring: ["Januar", "Februar", "Marec", "April", "Maj", "Junij", "Julij", "Avgust", "September", "Oktober", "November", "December"], day_for_recurring: ["Nedelja", "Ponedeljek", "Torek", "Sreda", "ÄŒetrtek", "Petek", "Sobota"] } };
  const sk = { date: { month_full: ["JanuÃ¡r", "FebruÃ¡r", "Marec", "AprÃ­l", "MÃ¡j", "JÃºn", "JÃºl", "August", "September", "OktÃ³ber", "November", "December"], month_short: ["Jan", "Feb", "Mar", "Apr", "MÃ¡j", "JÃºn", "JÃºl", "Aug", "Sept", "Okt", "Nov", "Dec"], day_full: ["NedeÄ¾a", "Pondelok", "Utorok", "Streda", "Å tvrtok", "Piatok", "Sobota"], day_short: ["Ne", "Po", "Ut", "St", "Å t", "Pi", "So"] }, labels: { dhx_cal_today_button: "Dnes", day_tab: "DeÅˆ", week_tab: "TÃ½Å¾deÅˆ", month_tab: "Mesiac", new_event: "NovÃ¡ udalosÅ¥", icon_save: "UloÅ¾iÅ¥", icon_cancel: "SpÃ¤Å¥", icon_details: "Detail", icon_edit: "Edituj", icon_delete: "ZmazaÅ¥", confirm_closing: "VaÅ¡e zmeny nebudÃº uloÅ¾enÃ©. SkutoÄne?", confirm_deleting: "UdalosÅ¥ bude natrvalo vymazanÃ¡. SkutoÄne?", section_description: "PoznÃ¡mky", section_time: "Doba platnosti", confirm_recurring: "Prajete si upraviÅ¥ celÃº radu opakovanÃ½ch udalostÃ­?", section_recurring: "Opakovanie udalosti", button_recurring: "VypnutÃ©", button_recurring_open: "ZapnutÃ©", button_edit_series: "UpraviÅ¥ opakovania", button_edit_occurrence: "UpraviÅ¥ inÅ¡tancie", button_edit_occurrence_and_following: "This and following events", agenda_tab: "Program", date: "DÃ¡tum", description: "PoznÃ¡mka", year_tab: "Rok", full_day: "CelÃ½ deÅˆ", week_agenda_tab: "Program", grid_tab: "MrieÅ¾ka", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "Denne", repeat_radio_week: "TÃ½Å¾denne", repeat_radio_month: "MesaÃ¨ne", repeat_radio_year: "RoÃ¨ne", repeat_radio_day_type: "KaÅ¾dÃ½", repeat_text_day_count: "deÃ²", repeat_radio_day_type2: "KaÅ¾dÃ½ prac. deÃ²", repeat_week: "Opakova kaÅ¾dÃ½", repeat_text_week_count: "tÃ½Å¾deÃ² v dÃ²och:", repeat_radio_month_type: "Opakova", repeat_radio_month_start: "On", repeat_text_month_day: "deÃ² kaÅ¾dÃ½", repeat_text_month_count: "mesiac", repeat_text_month_count2_before: "kaÅ¾dÃ½", repeat_text_month_count2_after: "mesiac", repeat_year_label: "On", select_year_day2: "poÃ¨as", repeat_text_year_day: "deÃ²", select_year_month: "mesiac", repeat_radio_end: "Bez dÃ¡tumu ukonÃ¨enia", repeat_text_occurrences_count: "udalostiach", repeat_radio_end3: "UkonÃ¨i", repeat_radio_end2: "Po", repeat_never: "Nikdy", repeat_daily: "KaÅ¾dÃ½ deÅˆ", repeat_workdays: "KaÅ¾dÃ½ pracovnÃ½ deÅˆ", repeat_weekly: "KaÅ¾dÃ½ tÃ½Å¾deÅˆ", repeat_monthly: "KaÅ¾dÃ½ mesiac", repeat_yearly: "KaÅ¾dÃ½ rok", repeat_custom: "VlastnÃ©", repeat_freq_day: "DeÅˆ", repeat_freq_week: "TÃ½Å¾deÅˆ", repeat_freq_month: "Mesiac", repeat_freq_year: "Rok", repeat_on_date: "Na dÃ¡tum", repeat_ends: "Koniec", month_for_recurring: ["JanuÃ¡r", "FebruÃ¡r", "Marec", "AprÃ­l", "MÃ¡j", "JÃºn", "JÃºl", "August", "September", "OktÃ³ber", "November", "December"], day_for_recurring: ["NedeÂ¾a", "Pondelok", "Utorok", "Streda", "Å tvrtok", "Piatok", "Sobota"] } };
  const sv = { date: { month_full: ["Januari", "Februari", "Mars", "April", "Maj", "Juni", "Juli", "Augusti", "September", "Oktober", "November", "December"], month_short: ["Jan", "Feb", "Mar", "Apr", "Maj", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dec"], day_full: ["SÃ¶ndag", "MÃ¥ndag", "Tisdag", "Onsdag", "Torsdag", "Fredag", "LÃ¶rdag"], day_short: ["SÃ¶n", "MÃ¥n", "Tis", "Ons", "Tor", "Fre", "LÃ¶r"] }, labels: { dhx_cal_today_button: "Idag", day_tab: "Dag", week_tab: "Vecka", month_tab: "MÃ¥nad", new_event: "Ny hÃ¤ndelse", icon_save: "Spara", icon_cancel: "Ã…ngra", icon_details: "Detaljer", icon_edit: "Ã„ndra", icon_delete: "Ta bort", confirm_closing: "", confirm_deleting: "Ã„r du sÃ¤ker pÃ¥ att du vill ta bort hÃ¤ndelsen permanent?", section_description: "Beskrivning", section_time: "Tid", full_day: "Hela dagen", confirm_recurring: "Vill du redigera hela serien med repeterande hÃ¤ndelser?", section_recurring: "Upprepa hÃ¤ndelse", button_recurring: "Inaktiverat", button_recurring_open: "Aktiverat", button_edit_series: "Redigera serien", button_edit_occurrence: "Redigera en kopia", button_edit_occurrence_and_following: "This and following events", agenda_tab: "Dagordning", date: "Datum", description: "Beskrivning", year_tab: "Ã…r", week_agenda_tab: "Dagordning", grid_tab: "Galler", drag_to_create: "Dra fÃ¶r att skapa ny", drag_to_move: "Dra fÃ¶r att flytta", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "Dagligen", repeat_radio_week: "Veckovis", repeat_radio_month: "MÃ¥nadsvis", repeat_radio_year: "Ã…rligen", repeat_radio_day_type: "Var", repeat_text_day_count: "dag", repeat_radio_day_type2: "Varje arbetsdag", repeat_week: " Upprepa var", repeat_text_week_count: "vecka dessa dagar:", repeat_radio_month_type: "Upprepa", repeat_radio_month_start: "Den", repeat_text_month_day: "dagen var", repeat_text_month_count: "mÃ¥nad", repeat_text_month_count2_before: "var", repeat_text_month_count2_after: "mÃ¥nad", repeat_year_label: "Den", select_year_day2: "i", repeat_text_year_day: "dag i", select_year_month: "mÃ¥nad", repeat_radio_end: "Inget slutdatum", repeat_text_occurrences_count: "upprepningar", repeat_radio_end3: "Sluta efter", repeat_radio_end2: "Efter", repeat_never: "Aldrig", repeat_daily: "Varje dag", repeat_workdays: "Varje vardag", repeat_weekly: "Varje vecka", repeat_monthly: "Varje mÃ¥nad", repeat_yearly: "Varje Ã¥r", repeat_custom: "Anpassad", repeat_freq_day: "Dag", repeat_freq_week: "Vecka", repeat_freq_month: "MÃ¥nad", repeat_freq_year: "Ã…r", repeat_on_date: "PÃ¥ datum", repeat_ends: "Slutar", month_for_recurring: ["Januari", "Februari", "Mars", "April", "Maj", "Juni", "Juli", "Augusti", "September", "Oktober", "November", "December"], day_for_recurring: ["SÃ¶ndag", "MÃ¥ndag", "Tisdag", "Onsdag", "Torsdag", "Fredag", "LÃ¶rdag"] } };
  const tr = { date: { month_full: ["Ocak", "Ãžubat", "Mart", "Nisan", "MayÃ½s", "Haziran", "Temmuz", "AÃ°ustos", "EylÃ¼l", "Ekim", "KasÃ½m", "AralÃ½k"], month_short: ["Oca", "Ãžub", "Mar", "Nis", "May", "Haz", "Tem", "AÃ°u", "Eyl", "Eki", "Kas", "Ara"], day_full: ["Pazar", "Pazartes,", "SalÃ½", "Ã‡arÃ¾amba", "PerÃ¾embe", "Cuma", "Cumartesi"], day_short: ["Paz", "Pts", "Sal", "Ã‡ar", "Per", "Cum", "Cts"] }, labels: { dhx_cal_today_button: "BugÃ¼n", day_tab: "GÃ¼n", week_tab: "Hafta", month_tab: "Ay", new_event: "Uygun", icon_save: "Kaydet", icon_cancel: "Ãptal", icon_details: "Detaylar", icon_edit: "DÃ¼zenle", icon_delete: "Sil", confirm_closing: "", confirm_deleting: "Etkinlik silinecek, devam?", section_description: "AÃ§Ã½klama", section_time: "Zaman aralÃ½Ã°Ã½", full_day: "Tam gÃ¼n", confirm_recurring: "TÃ¼m tekrar eden etkinlikler silinecek, devam?", section_recurring: "EtkinliÃ°i tekrarla", button_recurring: "Pasif", button_recurring_open: "Aktif", button_edit_series: "Dizi dÃ¼zenleme", button_edit_occurrence: "Bir kopyasÄ±nÄ± dÃ¼zenleyin", button_edit_occurrence_and_following: "This and following events", agenda_tab: "Ajanda", date: "Tarih", description: "AÃ§Ã½klama", year_tab: "YÃ½l", week_agenda_tab: "Ajanda", grid_tab: "Izgara", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "GÃ¼nlÃ¼k", repeat_radio_week: "HaftalÄ±k", repeat_radio_month: "AylÄ±k", repeat_radio_year: "YÄ±llÄ±k", repeat_radio_day_type: "Her", repeat_text_day_count: "gÃ¼n", repeat_radio_day_type2: "Her iÅŸ gÃ¼nÃ¼", repeat_week: " Tekrar her", repeat_text_week_count: "hafta ÅŸu gÃ¼nlerde:", repeat_radio_month_type: "Tekrar et", repeat_radio_month_start: "Tarihinde", repeat_text_month_day: "gÃ¼n her", repeat_text_month_count: "ay", repeat_text_month_count2_before: "her", repeat_text_month_count2_after: "ay", repeat_year_label: "Tarihinde", select_year_day2: "ayÄ±n", repeat_text_year_day: "gÃ¼nÃ¼", select_year_month: "ay", repeat_radio_end: "BitiÅŸ tarihi yok", repeat_text_occurrences_count: "olay", repeat_radio_end2: "Sonra", repeat_radio_end3: "Tarihinde bitir", repeat_never: "Asla", repeat_daily: "Her gÃ¼n", repeat_workdays: "Her iÅŸ gÃ¼nÃ¼", repeat_weekly: "Her hafta", repeat_monthly: "Her ay", repeat_yearly: "Her yÄ±l", repeat_custom: "Ã–zel", repeat_freq_day: "GÃ¼n", repeat_freq_week: "Hafta", repeat_freq_month: "Ay", repeat_freq_year: "YÄ±l", repeat_on_date: "Tarihinde", repeat_ends: "Biter", month_for_recurring: ["Ocak", "Åžubat", "Mart", "Nisan", "MayÄ±s", "Haziran", "Temmuz", "AÄŸustos", "EylÃ¼l", "Ekim", "KasÄ±m", "AralÄ±k"], day_for_recurring: ["Pazar", "Pazartesi", "SalÄ±", "Ã‡arÅŸamba", "PerÅŸembe", "Cuma", "Cumartesi"] } };
  const ua = { date: { month_full: ["Ð¡Ñ–Ñ‡ÐµÐ½ÑŒ", "Ð›ÑŽÑ‚Ð¸Ð¹", "Ð‘ÐµÑ€ÐµÐ·ÐµÐ½ÑŒ", "ÐšÐ²Ñ–Ñ‚ÐµÐ½ÑŒ", "Ð¢Ñ€Ð°Ð²ÐµÐ½ÑŒ", "Ð§ÐµÑ€Ð²ÐµÐ½ÑŒ", "Ð›Ð¸Ð¿ÐµÐ½ÑŒ", "Ð¡ÐµÑ€Ð¿ÐµÐ½ÑŒ", "Ð’ÐµÑ€ÐµÑÐµÐ½ÑŒ", "Ð–Ð¾Ð²Ñ‚ÐµÐ½ÑŒ", "Ð›Ð¸ÑÑ‚Ð¾Ð¿Ð°Ð´", "Ð“Ñ€ÑƒÐ´ÐµÐ½ÑŒ"], month_short: ["Ð¡Ñ–Ñ‡", "Ð›ÑŽÑ‚", "Ð‘ÐµÑ€", "ÐšÐ²Ñ–", "Ð¢Ñ€Ð°", "Ð§ÐµÑ€", "Ð›Ð¸Ð¿", "Ð¡ÐµÑ€", "Ð’ÐµÑ€", "Ð–Ð¾Ð²", "Ð›Ð¸Ñ", "Ð“Ñ€Ñƒ"], day_full: ["ÐÐµÐ´Ñ–Ð»Ñ", "ÐŸÐ¾Ð½ÐµÐ´Ñ–Ð»Ð¾Ðº", "Ð’Ñ–Ð²Ñ‚Ð¾Ñ€Ð¾Ðº", "Ð¡ÐµÑ€ÐµÐ´Ð°", "Ð§ÐµÑ‚Ð²ÐµÑ€", "ÐŸ'ÑÑ‚Ð½Ð¸Ñ†Ñ", "Ð¡ÑƒÐ±Ð¾Ñ‚Ð°"], day_short: ["ÐÐµÐ´", "ÐŸÐ¾Ð½", "Ð’Ñ–Ð²", "Ð¡ÐµÑ€", "Ð§ÐµÑ‚", "ÐŸÑ‚Ð½", "Ð¡ÑƒÐ±"] }, labels: { dhx_cal_today_button: "Ð¡ÑŒÐ¾Ð³Ð¾Ð´Ð½Ñ–", day_tab: "Ð”ÐµÐ½ÑŒ", week_tab: "Ð¢Ð¸Ð¶Ð´ÐµÐ½ÑŒ", month_tab: "ÐœÑ–ÑÑÑ†ÑŒ", new_event: "ÐÐ¾Ð²Ð° Ð¿Ð¾Ð´Ñ–Ñ", icon_save: "Ð—Ð±ÐµÑ€ÐµÐ³Ñ‚Ð¸", icon_cancel: "Ð’Ñ–Ð´Ð¼Ñ–Ð½Ð°", icon_details: "Ð”ÐµÑ‚Ð°Ð»Ñ–", icon_edit: "Ð ÐµÐ´Ð°Ð³ÑƒÐ²Ð°Ñ‚Ð¸", icon_delete: "Ð’Ð¸Ð»ÑƒÑ‡Ð¸Ñ‚Ð¸", confirm_closing: "", confirm_deleting: "ÐŸÐ¾Ð´Ñ–Ñ Ð²Ð¸Ð»ÑƒÑ‡Ð¸Ñ‚ÑŒÑÑ Ð½Ð°Ð·Ð°Ð²Ð¶Ð´Ð¸. Ð’Ð¸ Ð²Ð¿ÐµÐ²Ð½ÐµÐ½Ñ–?", section_description: "ÐžÐ¿Ð¸Ñ", section_time: "Ð§Ð°ÑÐ¾Ð²Ð¸Ð¹ Ð¿Ñ€Ð¾Ð¼Ñ–Ð¶Ð¾Ðº", full_day: "Ð’ÐµÑÑŒ Ð´ÐµÐ½ÑŒ", confirm_recurring: "Ð¥Ð¾Ñ‡ÐµÑ‚Ðµ Ñ€ÐµÐ´Ð°Ð³ÑƒÐ²Ð°Ñ‚Ð¸ Ð²ÐµÑÑŒ Ð¿ÐµÑ€ÐµÐ»Ñ–Ðº Ð¿Ð¾Ð²Ñ‚Ð¾Ñ€ÑŽÐ²Ð°Ð½Ð¸Ñ… Ð¿Ð¾Ð´Ñ–Ð¹?", section_recurring: "ÐŸÐ¾Ð²Ñ‚Ð¾Ñ€ÑŽÐ²Ð°Ð½Ð° Ð¿Ð¾Ð´Ñ–Ñ", button_recurring: "Ð’Ñ–Ð´ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¾", button_recurring_open: "Ð’ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¾", button_edit_series: "Ð ÐµÐ´Ð°Ð³ÑƒÐ²Ð°Ñ‚Ð¸ ÑÐµÑ€Ñ–ÑŽ", button_edit_occurrence: "Ð ÐµÐ´Ð°Ð³ÑƒÐ²Ð°Ñ‚Ð¸ Ð¿Ñ€Ð¸Ð¼Ñ–Ñ€Ð½Ð¸Ðº", button_edit_occurrence_and_following: "This and following events", agenda_tab: "ÐŸÐµÑ€ÐµÐ»Ñ–Ðº", date: "Ð”Ð°Ñ‚Ð°", description: "ÐžÐ¿Ð¸Ñ", year_tab: "Ð Ñ–Ðº", week_agenda_tab: "ÐŸÐµÑ€ÐµÐ»Ñ–Ðº", grid_tab: "Ð¢Ð°Ð±Ð»Ð¸Ñ†Ñ", drag_to_create: "Drag to create", drag_to_move: "Drag to move", message_ok: "OK", message_cancel: "Cancel", next: "Next", prev: "Previous", year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", repeat_radio_day: "Ð”ÐµÐ½ÑŒ", repeat_radio_week: "Ð¢Ð¸Ð¶Ð´ÐµÐ½ÑŒ", repeat_radio_month: "ÐœÑ–ÑÑÑ†ÑŒ", repeat_radio_year: "Ð Ñ–Ðº", repeat_radio_day_type: "ÐšÐ¾Ð¶Ð½Ð¸Ð¹", repeat_text_day_count: "Ð´ÐµÐ½ÑŒ", repeat_radio_day_type2: "ÐšÐ¾Ð¶Ð½Ð¸Ð¹ Ñ€Ð¾Ð±Ð¾Ñ‡Ð¸Ð¹ Ð´ÐµÐ½ÑŒ", repeat_week: " ÐŸÐ¾Ð²Ñ‚Ð¾Ñ€ÑŽÐ²Ð°Ñ‚Ð¸ ÐºÐ¾Ð¶ÐµÐ½", repeat_text_week_count: "Ñ‚Ð¸Ð¶Ð´ÐµÐ½ÑŒ , Ð¿Ð¾:", repeat_radio_month_type: "ÐŸÐ¾Ð²Ñ‚Ð¾Ñ€ÑŽÐ²Ð°Ñ‚Ð¸", repeat_radio_month_start: "", repeat_text_month_day: " Ñ‡Ð¸ÑÐ»Ð° ÐºÐ¾Ð¶Ð½Ð¸Ð¹ ", repeat_text_month_count: "Ð¼Ñ–ÑÑÑ†ÑŒ", repeat_text_month_count2_before: "ÐºÐ¾Ð¶ÐµÐ½ ", repeat_text_month_count2_after: "Ð¼Ñ–ÑÑÑ†ÑŒ", repeat_year_label: "", select_year_day2: "", repeat_text_year_day: "Ð´ÐµÐ½ÑŒ", select_year_month: "", repeat_radio_end: "Ð‘ÐµÐ· Ð´Ð°Ñ‚Ð¸ Ð·Ð°ÐºÑ–Ð½Ñ‡ÐµÐ½Ð½Ñ", repeat_text_occurrences_count: "Ð¿Ð¾Ð²Ñ‚Ð¾Ñ€ÐµÐ½ÑŒ", repeat_radio_end3: "Ð”Ð¾ ", repeat_radio_end2: "", repeat_never: "ÐÑ–ÐºÐ¾Ð»Ð¸", repeat_daily: "Ð©Ð¾Ð´Ð½Ñ", repeat_workdays: "Ð©Ð¾Ð´Ð½Ñ Ð² Ñ€Ð¾Ð±Ð¾Ñ‡Ñ– Ð´Ð½Ñ–", repeat_weekly: "Ð©Ð¾Ñ‚Ð¸Ð¶Ð½Ñ", repeat_monthly: "Ð©Ð¾Ð¼Ñ–ÑÑÑ†Ñ", repeat_yearly: "Ð©Ð¾Ñ€Ð¾ÐºÑƒ", repeat_custom: "ÐÐ°Ð»Ð°ÑˆÑ‚Ð¾Ð²Ð°Ð½Ðµ", repeat_freq_day: "Ð”ÐµÐ½ÑŒ", repeat_freq_week: "Ð¢Ð¸Ð¶Ð´ÐµÐ½ÑŒ", repeat_freq_month: "ÐœÑ–ÑÑÑ†ÑŒ", repeat_freq_year: "Ð Ñ–Ðº", repeat_on_date: "ÐÐ° Ð´Ð°Ñ‚Ñƒ", repeat_ends: "Ð—Ð°ÐºÑ–Ð½Ñ‡ÑƒÑ”Ñ‚ÑŒÑÑ", month_for_recurring: ["ÑÑ–Ñ‡Ð½Ñ", "Ð»ÑŽÑ‚Ð¾Ð³Ð¾", "Ð±ÐµÑ€ÐµÐ·Ð½Ñ", "ÐºÐ²Ñ–Ñ‚Ð½Ñ", "Ñ‚Ñ€Ð°Ð²Ð½Ñ", "Ñ‡ÐµÑ€Ð²Ð½Ñ", "Ð»Ð¸Ð¿Ð½Ñ", "ÑÐµÑ€Ð¿Ð½Ñ", "Ð²ÐµÑ€ÐµÑÐ½Ñ", "Ð¶Ð¾Ð²Ñ‚Ð½Ñ", "Ð»Ð¸ÑÑ‚Ð¾Ð¿Ð°Ð´Ð°", "Ð³Ñ€ÑƒÐ´Ð½Ñ"], day_for_recurring: ["ÐÐµÐ´Ñ–Ð»ÑÐ¼", "ÐŸÐ¾Ð½ÐµÐ´Ñ–Ð»ÐºÐ°Ð¼", "Ð’Ñ–Ð²Ñ‚Ð¾Ñ€ÐºÐ°Ð¼", "Ð¡ÐµÑ€ÐµÐ´Ð°Ð¼", "Ð§ÐµÑ‚Ð²ÐµÑ€Ð³Ð°Ð¼", "ÐŸ'ÑÑ‚Ð½Ð¸Ñ†ÑÐ¼", "Ð¡ÑƒÐ±Ð¾Ñ‚Ð°Ð¼"] } };
    ...
    function toXML(start, end, view, mode, header, footer) {
      ...
      if (start) {
        ...
        for (var temp_date = new Date(start); +temp_date < +end; temp_date = this.date.add(temp_date, 1, view)) {
          ...
          xml += xml_start("page") + xml_body_header().replace("â€“", "-") + xml_body(colors) + xml_end("page");
        }
        xml += xml_end("pages");
        this.setCurrentView(original_date, original_mode);
      } else {
        xml = xml_top("data", mode, header, footer) + xml_body_header().replace("â€“", "-") + xml_body(colors) + xml_end("data");
      }
      return xml;
    }
